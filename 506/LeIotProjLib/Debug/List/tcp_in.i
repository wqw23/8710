...
tcp_input(struct pbuf *p, struct netif *inp)
{
  ...
  struct tcp_pcb *lpcb_prev = 0;
  struct tcp_pcb_listen *lpcb_any = 0;
  ...
  if (pbuf_header(p, -((s16_t)(((iphdr)->_v_hl & 0x0f) * 4))) || (p->tot_len < sizeof(struct tcp_hdr))) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: short packet (%" "d" " bytes) discarded\n", p->tot_len); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
    goto dropped;
  }
  ...
  if (inet_chksum_pseudo(p, (&current_iphdr_src), (&current_iphdr_dest),
      6, p->tot_len) != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: packet discarded due to failing checksum 0x%04" "x" "\n", inet_chksum_pseudo(p, (&current_iphdr_src), (&current_iphdr_dest), 6, p->tot_len)); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if(pbuf_header(p, -(hdrlen * 4))){
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: short packet\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
    goto dropped;
  }
  ...
  if (pcb == 0) {
    ...
    for(pcb = tcp_tw_pcbs; pcb != 0; pcb = pcb->next) {
      ...
      if (pcb->remote_port == tcphdr->src &&
        ...
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: packed for TIME_WAITing connection.\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
#line 234 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\tcp_in.c"
      }
    ...
    if (lpcb != 0) {
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: packed for LISTENing connection.\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ...
      if (recv_flags & (u8_t)0x08U) {
        ...
        if (recv_data != 0) {
          ...
          if (err != 0) {
            ...
            do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: keep incoming packet, because pcb is \"full\"\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
          }
        }
...
aborted:
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: no PCB match found, resetting.\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
tcp_listen_input(struct tcp_pcb_listen *pcb)
{
  ...
  if (flags & 0x10U) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_listen_input: ACK in LISTEN, sending reset\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    tcp_rst(ackno, seqno + tcplen, (&current_iphdr_dest),
      (&current_iphdr_src), tcphdr->dest, tcphdr->src);
  } else if (flags & 0x02U) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("TCP connection request %" "d" " -> %" "d" ".\n", tcphdr->src, tcphdr->dest); if ((0x00U) & 0x08U) { while(1); } } } while(0);
#line 466 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\tcp_in.c"
    npcb = tcp_alloc(pcb->prio);
    

 
    if (npcb == 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_listen_input: could not allocate PCB\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ;
      return -1;
    }
...
tcp_process(struct tcp_pcb *pcb)
{
  ...
  if (flags & 0x04U) {
    ...
    if (acceptable) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_process: Connection RESET\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { if(!(pcb->state != CLOSED)) ; } while(0);
      recv_flags |= (u8_t)0x08U;
      pcb->flags &= ~((u8_t)0x01U);
      return -11;
    } else {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_process: unacceptable reset seqno %" "d" " rcv_nxt %" "d" "\n", seqno, pcb->rcv_nxt); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  switch (pcb->state) {
  case SYN_SENT:
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("SYN-SENT: ackno %" "d" " pcb->snd_nxt %" "d" " unacked %" "d" "\n", ackno, pcb->snd_nxt, lwip_ntohl(pcb->unacked->tcphdr->seqno)); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    if ((flags & 0x10U) && (flags & 0x02U)
      ...
      --pcb->snd_queuelen;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_process: SYN-SENT --queuelen %" "d" "\n", (u16_t)pcb->snd_queuelen); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      rseg = pcb->unacked;
  ...
  case SYN_RCVD:
    if (flags & 0x10U) {
      ...
      if ((((s32_t)((u32_t)(ackno) - (u32_t)(pcb->lastack+1)) >= 0) && ((s32_t)((u32_t)(ackno) - (u32_t)(pcb->snd_nxt)) <= 0))) {
        u16_t old_cwnd;
        pcb->state = ESTABLISHED;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("TCP connection established %" "d" " -> %" "d" ".\n", inseg . tcphdr->src, inseg . tcphdr->dest); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  case FIN_WAIT_1:
    ...
    if (recv_flags & (u8_t)0x20U) {
      if ((flags & 0x10U) && (ackno == pcb->snd_nxt)) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("TCP connection closed: FIN_WAIT_1 %" "d" " -> %" "d" ".\n", inseg . tcphdr->src, inseg . tcphdr->dest); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  case FIN_WAIT_2:
    tcp_receive(pcb);
    if (recv_flags & (u8_t)0x20U) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("TCP connection closed: FIN_WAIT_2 %" "d" " -> %" "d" ".\n", inseg . tcphdr->src, inseg . tcphdr->dest); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { (pcb)->flags |= ((u8_t)0x02U); } while (0);
      tcp_pcb_purge(pcb);
      do { do { if(*(&tcp_active_pcbs) == (pcb)) { (*(&tcp_active_pcbs)) = (* &tcp_active_pcbs)->next; } else { for(tcp_tmp_pcb = * &tcp_active_pcbs; tcp_tmp_pcb != 0; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 0; } while(0); tcp_active_pcbs_changed = 1; } while (0);
      pcb->state = TIME_WAIT;
  ...
  case CLOSING:
    tcp_receive(pcb);
    if (flags & 0x10U && ackno == pcb->snd_nxt) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("TCP connection closed: CLOSING %" "d" " -> %" "d" ".\n", inseg . tcphdr->src, inseg . tcphdr->dest); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      tcp_pcb_purge(pcb);
      do { do { if(*(&tcp_active_pcbs) == (pcb)) { (*(&tcp_active_pcbs)) = (* &tcp_active_pcbs)->next; } else { for(tcp_tmp_pcb = * &tcp_active_pcbs; tcp_tmp_pcb != 0; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 0; } while(0); tcp_active_pcbs_changed = 1; } while (0);
      pcb->state = TIME_WAIT;
      do { (pcb)->next = * &tcp_tw_pcbs; *(&tcp_tw_pcbs) = (pcb); tcp_timer_needed(); } while (0);
  ...
  case LAST_ACK:
    tcp_receive(pcb);
    if (flags & 0x10U && ackno == pcb->snd_nxt) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("TCP connection closed: LAST_ACK %" "d" " -> %" "d" ".\n", inseg . tcphdr->src, inseg . tcphdr->dest); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
tcp_receive(struct tcp_pcb *pcb)
{
  ...
  if (flags & 0x10U) {
    ...
    if (((s32_t)((u32_t)(pcb->snd_wl1) - (u32_t)(seqno)) < 0) ||
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: window update %" "d" "\n", pcb->snd_wnd); if ((0x00U) & 0x08U) { while(1); } } } while(0);
#line 901 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\tcp_in.c"
    }
    ...
    if (((s32_t)((u32_t)(ackno) - (u32_t)(pcb->lastack)) <= 0)) {
      ...
      if (pcb->state >= ESTABLISHED) {
        if (pcb->cwnd < pcb->ssthresh) {
          ...
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: slow start cwnd %" "d" "\n", pcb->cwnd); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        } else {
          u16_t new_cwnd = (pcb->cwnd + pcb->mss * pcb->mss / pcb->cwnd);
          if (new_cwnd > pcb->cwnd) {
            pcb->cwnd = new_cwnd;
          }
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: congestion avoidance cwnd %" "d" "\n", pcb->cwnd); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        }
      }
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: ACK for %" "d" ", unacked->seqno %" "d" ":%" "d" "\n", ackno, pcb->unacked != 0? lwip_ntohl(pcb->unacked->tcphdr->seqno): 0, pcb->unacked != 0? lwip_ntohl(pcb->unacked->tcphdr->seqno) + ((pcb->unacked)->len + (((lwip_ntohs(((pcb->unacked)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & (0x01U | 0x02U)) != 0)): 0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ...
      while (pcb->unacked != 0 &&
        ...
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: queuelen %" "d" " ... ", (u16_t)pcb->snd_queuelen); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        ...
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("%" "d" " (after freeing unacked)\n", (u16_t)pcb->snd_queuelen); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    while (pcb->unsent != 0 &&
      ...
      pcb->snd_queuelen -= pbuf_clen(next->p);
      tcp_seg_free(next);
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("%" "d" " (after freeing unsent)\n", (u16_t)pcb->snd_queuelen); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      if (pcb->snd_queuelen != 0) {
        do { if(!(pcb->unacked != 0 || pcb->unsent != 0)) ; } while(0);
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: pcb->rttest %" "d" " rtseq %" "d" " ackno %" "d" "\n", pcb->rttest, pcb->rtseq, ackno); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->rttest && ((s32_t)((u32_t)(pcb->rtseq) - (u32_t)(ackno)) < 0)) {
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: experienced rtt %" "d" " ticks (%" "d" " msec).\n", m, m * (2*250)); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: RTO %" "d" " (%" "d" " milliseconds)\n", pcb->rto, pcb->rto * (2*250)); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if ((tcplen > 0) && (pcb->state < CLOSE_WAIT)) {
    ...
    if ((((s32_t)((u32_t)(pcb->rcv_nxt) - (u32_t)(seqno + 1)) >= 0) && ((s32_t)((u32_t)(pcb->rcv_nxt) - (u32_t)(seqno + tcplen - 1)) <= 0))){
      ...
      if (((s32_t)((u32_t)(seqno) - (u32_t)(pcb->rcv_nxt)) < 0)){
        ...
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: duplicate seqno %" "d" "\n", seqno); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        do { (pcb)->flags |= ((u8_t)0x02U); } while (0);
      }
    }
    ...
    if ((((s32_t)((u32_t)(seqno) - (u32_t)(pcb->rcv_nxt)) >= 0) && ((s32_t)((u32_t)(seqno) - (u32_t)(pcb->rcv_nxt + pcb->rcv_wnd - 1)) <= 0))){
      ...
      if (pcb->rcv_nxt == seqno) {
        ...
        if (tcplen > pcb->rcv_wnd) {
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: other end overran receive window" "seqno %" "d" " len %" "d" " right edge %" "d" "\n", seqno, tcplen, pcb->rcv_nxt + pcb->rcv_wnd); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        ...
        if (pcb->ooseq != 0) {
          if ((lwip_ntohs((inseg . tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
            do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: received in-order FIN, binning ooseq queue\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
            ...
            if (next &&
              ...
              pbuf_realloc(inseg.p, inseg.len);
              tcplen = ((&inseg)->len + (((lwip_ntohs(((&inseg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & (0x01U | 0x02U)) != 0));
              do { if(!((seqno + tcplen) == next->tcphdr->seqno)) ; } while(0);
        ...
        if ((lwip_ntohs((inseg . tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: received FIN.\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        ...
        while (pcb->ooseq != 0 &&
          ...
          do { if(!(pcb->rcv_wnd >= ((cseg)->len + (((lwip_ntohs(((cseg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & (0x01U | 0x02U)) != 0)))) ; } while(0);
          ...
          if ((lwip_ntohs((cseg->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
            do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_receive: dequeued FIN.\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
            recv_flags |= (u8_t)0x20U;
            if (pcb->state == ESTABLISHED) {  
              pcb->state = CLOSE_WAIT;
            } 
...
#line 1517 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\tcp_in.c"
      }
    } else {
  ...
  if((lwip_ntohs((tcphdr)->_hdrlen_rsvd_flags) >> 12) > 0x5) {
    ...
    for (c = 0; c < max_c; ) {
      ...
      case 0x00:
        ...
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_parseopt: EOL\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        return;
      case 0x01:
         
        ++c;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_parseopt: NOP\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        break;
      case 0x02:
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_parseopt: MSS\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        if (opts[c + 1] != 0x04 || c + 0x04 > max_c) {
           
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_parseopt: bad length\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
          return;
        }
        ...
        c += 0x04;
        break;
#line 1603 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\tcp_in.c"
      default:
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_parseopt: other\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        if (opts[c + 1] == 0) {
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_parseopt: bad length\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
