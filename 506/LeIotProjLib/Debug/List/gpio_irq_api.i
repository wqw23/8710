#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_irq_api.c"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_irq_api.c"
...
#line 20 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_irq_api.c"
...
#line 29 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal\\gpio_irq_api.h"
...
#line 22 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_irq_api.c"
...
#line 23 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_irq_api.c"
...
int gpio_irq_init(gpio_irq_t *obj, PinName pin, gpio_irq_handler handler, uint32_t id) 
{
	...
	RCC_PeriphClockCmd(((1<<(8)) | 3 << 30), ((1<<(24))), 1);
	GPIO_INTConfig(pin, 0);

	GPIO_InitStruct.GPIO_Pin = obj->pin;
	GPIO_InitStruct.GPIO_Mode = 0x02;
	GPIO_InitStruct.GPIO_ITTrigger = 0x1;
	GPIO_InitStruct.GPIO_ITPolarity = 0x0;

	VECTOR_IrqRegister(GPIO_INTHandler, GPIO_IRQ, 0, 10);		
	VECTOR_IrqEn(GPIO_IRQ, 10);
...
void gpio_irq_set(gpio_irq_t *obj, gpio_irq_event event, uint32_t enable) 
{
	...
	if (enable) {
		GPIO_INTMode(obj->pin, 1, GPIO_ITTrigger, GPIO_ITPolarity, 0x1);
	} else {
		GPIO_INTMode(obj->pin, 0, 0, 0, 0);
	}
}
