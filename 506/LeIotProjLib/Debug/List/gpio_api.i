#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c"
...
#line 18 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c"
...
#line 21 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c"
...
uint32_t gpio_set(PinName pin) 
{
	...
	((pin != (PinName)NC) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c", 31));
	pin_function(pin, 0);
...
void gpio_mode(gpio_t *obj, PinMode mode) 
{
	...
	switch (mode) {
		...
		case OpenDrain: 
			GPIO_PuPd = 0x00;
			GPIO_Direction(obj->pin, 0x01);
			GPIO_WriteBit(obj->pin, 0);
		break;
...
void gpio_dir(gpio_t *obj, PinDirection direction)
{
	((obj->pin != (PinName)NC) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c", 113));
	
	if (direction == PIN_OUTPUT) {
		GPIO_Direction(obj->pin, 0x01);
	} else {
		GPIO_Direction(obj->pin, 0x00);
	}
}
...
void gpio_write(gpio_t *obj, int value) 
{
	((obj->pin != (PinName)NC) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c", 146));
...
int gpio_read(gpio_t *obj)
{
	((obj->pin != (PinName)NC) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\gpio_api.c", 174));
