...
tcp_abandon(struct tcp_pcb *pcb, int reset)
{
  ...
  if (pcb->state == TIME_WAIT) {
    ...
    if (reset) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_abandon: sending RST\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
tcp_bind(struct tcp_pcb *pcb, ip_addr_t *ipaddr, u16_t port)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_bind: bind to port %" "d" "\n", port); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  return 0;
}
  ...
  if (((pcb)->so_options & (0x04U))) {
    ...
    for(lpcb = tcp_listen_pcbs.listen_pcbs; lpcb != 0; lpcb = lpcb->next) {
      if (lpcb->local_port == pcb->local_port) {
        if (((&lpcb->local_ip)->addr == (&pcb->local_ip)->addr)) {
...
tcp_recved(struct tcp_pcb *pcb, u16_t len)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_recved: recveived %" "d" " bytes, wnd %" "d" " (%" "d" ").\n", len, pcb->rcv_wnd, (4*(1500 - 40)) - pcb->rcv_wnd); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ...
      tcp_connected_fn connected)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_connect to port %" "d" "\n", port); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  if (ipaddr != 0) {
...
tcp_slowtmr_start:
  ...
  pcb = tcp_active_pcbs;
  if (pcb == 0) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: no active pcbs\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  }
  while (pcb != 0) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: processing active pcb\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->state == SYN_SENT && pcb->nrtx == 6) {
      ++pcb_remove;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: max SYN retries reached\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    else if (pcb->nrtx == 12) {
      ++pcb_remove;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: max DATA retries reached\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    } else {
      if (pcb->persist_backoff > 0) {
        ...
        if (pcb->unacked != 0 && pcb->rtime >= pcb->rto) {
          ...
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: rtime %" "d" " pcb->rto %" "d" "\n", pcb->rtime, pcb->rto); if ((0x00U) & 0x08U) { while(1); } } } while(0);
          ...
          pcb->cwnd = pcb->mss;
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: cwnd %" "d" " ssthresh %" "d" "\n", pcb->cwnd, pcb->ssthresh); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->state == FIN_WAIT_2) {
      ...
      if (pcb->flags & ((u8_t)0x10U)) {
        ...
        if ((u32_t)(tcp_ticks - pcb->tmr) >
            20000 / (2*250)) {
          ++pcb_remove;
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: removing pcb stuck in FIN-WAIT-2\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        }
      }
    }
    ...
    if (pcb->ooseq != 0 &&
      ...
      tcp_segs_free(pcb->ooseq);
      pcb->ooseq = 0;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: dropping OOSEQ queued data\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    ...
    if (pcb->state == SYN_RCVD) {
      if ((u32_t)(tcp_ticks - pcb->tmr) >
          20000 / (2*250)) {
        ++pcb_remove;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: removing pcb stuck in SYN-RCVD\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }
    ...
    if (pcb->state == LAST_ACK) {
      if ((u32_t)(tcp_ticks - pcb->tmr) > 2 * 60000UL / (2*250)) {
        ++pcb_remove;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: removing pcb stuck in LAST-ACK\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }
    ...
    if (pcb_remove) {
      ...
      if (prev->polltmr >= prev->pollinterval) {
        prev->polltmr = 0;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_slowtmr: polling application\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        tcp_active_pcbs_changed = 0;
  ...
  while(pcb != 0) {
    if (pcb->last_timer != tcp_timer_ctr) {
      ...
      if (pcb->flags & ((u8_t)0x01U)) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_fasttmr: delayed ACK\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        do { (pcb)->flags |= ((u8_t)0x02U); } while (0);
        tcp_output(pcb);
...
tcp_process_refused_data(struct tcp_pcb *pcb)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: notify kept packet\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if (err == 0) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_input: drop incoming packets, because pcb is \"full\"\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return -10;
  } else {
...
tcp_seg_copy(struct tcp_seg *seg)
{
  ...
  _memcpy((u8_t *)cseg, (const u8_t *)seg, sizeof(struct tcp_seg)); 
  pbuf_ref(cseg->p);
  return cseg;
}
...
tcp_kill_prio(u8_t prio)
{
  ...
  if (inactive != 0) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_kill_prio: killing oldest PCB %p (%" "d" ")\n", (void *)inactive, inactivity); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
tcp_kill_timewait(void)
{
  ...
  if (inactive != 0) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_kill_timewait: killing oldest TIME-WAIT PCB %p (%" "d" ")\n", (void *)inactive, inactivity); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
tcp_alloc(u8_t prio)
{
  ...
  if (pcb == 0) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_alloc: killing off oldest TIME-WAIT connection\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    tcp_kill_timewait();
     
    pcb = (struct tcp_pcb *)memp_malloc(MEMP_TCP_PCB);
    if (pcb == 0) {
       
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_alloc: killing connection with prio lower than %d\n", prio); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      tcp_kill_prio(prio);
...
tcp_pcb_purge(struct tcp_pcb *pcb)
{
  if (pcb->state != CLOSED &&
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_pcb_purge\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);

#line 1498 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\tcp.c"


    if (pcb->refused_data != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_pcb_purge: data left on ->refused_data\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      pbuf_free(pcb->refused_data);
      pcb->refused_data = 0;
    }
    if (pcb->unsent != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_pcb_purge: not all data sent\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    if (pcb->unacked != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_pcb_purge: data left on ->unacked\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }

    if (pcb->ooseq != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcp_pcb_purge: data left on ->ooseq\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    tcp_segs_free(pcb->ooseq);
    pcb->ooseq = 0;
...
#line 1742 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\tcp.c"
