#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\googlenest\\example_google.c"
...
#line 54 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\googlenest\\example_google.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\googlenest\\example_google.c"
...
_Pragma("function_effects = no_state, no_errno")     __intrinsic __nounwind int abs(int);
             __intrinsic __nounwind void * calloc_freertos(size_t, size_t);
_Pragma("function_effects = no_state, no_errno")     __intrinsic __nounwind div_t div(int, int);
             __intrinsic __nounwind void vPortFree(void *);
...
_Pragma("function_effects = no_state, no_errno")     __intrinsic __nounwind ldiv_t ldiv(long, long);
    ...
    #pragma language=restore
             ...
             __intrinsic __nounwind void * pvPortMalloc(size_t);
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\googlenest\\example_google.c"
...
#line 6 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\googlenest\\example_google.c"

#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\example\\googlenest/example_google.h"
...
#line 8 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\googlenest\\example_google.c"
...
#line 9 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\googlenest\\example_google.c"
...
void google_data_retrieve(char *response_buf) {
	...
	char *event = 0;
	char *delims = "\n";
	char *data = 0, *backup = 0;
	char *info = 0;
	cJSON_Hooks memoryHook;

	event = strtok_r(response_buf, delims, &backup);
	data = strtok_r( 0, delims, &backup );

	if (!_strncmp(data, "data: ", prvStrLen((const unsigned char *) "data: "))){
		info = data + prvStrLen((const unsigned char *) "data: ");
		if(info != 0){
			...
			if((infoJSObject = cJSON_Parse(info)) != 0) {
...
void gn_todevice_start(void) {
	...
	char *googlenest_host = "your_firebase_address.firebaseio.com";
...
reconnect:
	if(gn_connect(&googlenest, googlenest_host, 443) == 0) {
		rtl_printf("\r\n Connection is OK!\r\n");
...
void gn_fromdevice_start(int type) {
	...
	while(1) {
		_memset(&googlenest, 0, sizeof(googlenest_context));
		if(gn_connect(&googlenest, "your_firebase_address.firebaseio.com", 443) == 0) {
			char *data;
			
			if(type == 1){
				cJSON *MSJSObject;
				if((MSJSObject = cJSON_CreateObject()) != 0) {
				...
				if((dataJSObject = cJSON_CreateObject()) != 0) {

					if((lightJSObject = cJSON_CreateObject()) != 0) {
...
void example_google(char *type) {
	...
	if(prvStrCmp((const unsigned char *) type, (const unsigned char *) "FromDevice") == 0){
		if(xTaskGenericCreate( ( gn_fromdevice_task ), ( ((const char*)"gn_fromdevice_task") ), ( 768 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
			rtl_printf("\n\r%s xTaskCreate failed", __FUNCTION__);
	}
	else if(prvStrCmp((const unsigned char *) type, (const unsigned char *) "ToDevice") == 0){
		if(xTaskGenericCreate( ( gn_todevice_task ), ( ((const char*)"gn_todevice_task") ), ( 1000 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
			rtl_printf("\n\r%s xTaskCreate failed", __FUNCTION__);
	}
	else if(prvStrCmp((const unsigned char *) type, (const unsigned char *) "BOTH") == 0){              
		if(xTaskGenericCreate( ( gn_both_fromdevice_task ), ( ((const char*)"gn_both_fromdevice_task") ), ( 768 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
			rtl_printf("\n\r%s xTaskCreate failed", __FUNCTION__);
		if(xTaskGenericCreate( ( gn_both_todevice_task ), ( ((const char*)"gn_both_todevice_task") ), ( 1000 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
			rtl_printf("\n\r%s xTaskCreate failed", __FUNCTION__);
	}
