#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\xml\\example_xml.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\xml\\example_xml.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\xml\\example_xml.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\xml\\example_xml.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\utilities\\xml.h"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\xml\\example_xml.c"
...
static void example_xml_thread(void *param)
{
	...
	power_node = xml_new_element(0, "Power", 0);
	xml_add_child(power_node, xml_new_text("on"));
	color_node = xml_new_element(0, "Color", 0);
	red_node = xml_new_element(0, "Red", 0);
	xml_add_child(red_node, xml_new_text("255"));
	green_node = xml_new_element(0, "Green", 0);
	xml_add_child(green_node, xml_new_text("255"));
	blue_node = xml_new_element(0, "Blue", 0);
	...
	char *doc = "		<?xml version=\"1.0\"?>		<!--sensor example-->		<Home:Sensor>			<Thermostat>				<Mode>auto</Mode>				<Temperature unit=\"celsius\">25.5</Temperature>			</Thermostat>		</Home:Sensor>";
#line 64 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\xml\\example_xml.c"

	
	struct xml_node *root = xml_parse(doc, prvStrLen((const unsigned char *) doc));

	if(root) {
		dump_buf = xml_dump_tree_ex(root, 0, 1, 4);
		rtl_printf("\n%s\n", dump_buf);
		xml_free(dump_buf);
...
{
	if(xTaskGenericCreate( ( example_xml_thread ), ( ((const char*)"example_xml_thread") ), ( 1024 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
