#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c"
#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.h"
...
#line 30 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.h"
...
#line 20 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c"
...
void gtimer_init (gtimer_t *obj, uint32_t tid)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 59));

	obj->timer_id = tid;

	RTIM_TimeBaseStructInit(&TIM_InitStruct);
	TIM_InitStruct.TIM_Idx = (uint8_t)tid;

	TIM_InitStruct.TIM_UpdateEvent = 1;  
	TIM_InitStruct.TIM_UpdateSource = ((uint32_t)0x00000004);
	TIM_InitStruct.TIM_ARRProtection = 1;
	
	RTIM_TimeBaseInit(TIMx[tid], &TIM_InitStruct, TIMx_irq[tid], (IRQ_FUN) gtimer_timeout_handler, (uint32_t)obj);
}
...
void gtimer_deinit (gtimer_t *obj)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 82));
...
uint32_t gtimer_read_tick (gtimer_t *obj)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 96));
...
uint64_t gtimer_read_us (gtimer_t *obj)  
{
	(((obj->timer_id < GTIMER_MAX) && (obj->timer_id > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 108));
...
void gtimer_reload (gtimer_t *obj, uint32_t duration_us)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 127));
...
void gtimer_start (gtimer_t *obj)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 141));

	RTIM_INTConfig(TIMx[tid], ((uint32_t)0x00000001), 1);
	RTIM_Cmd(TIMx[tid], 1);
}
...
void gtimer_start_one_shout (gtimer_t *obj, uint32_t duration_us, void* handler, uint32_t hid)
{
	(((obj->timer_id < GTIMER_MAX) && (obj->timer_id > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 158));
...
void gtimer_start_periodical (gtimer_t *obj, uint32_t duration_us, void* handler, uint32_t hid)
{
	(((obj->timer_id < GTIMER_MAX) && (obj->timer_id > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 179));
...
void gtimer_stop (gtimer_t *obj)
{
	...
	(((tid < GTIMER_MAX) && (tid > TIMER0)) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\timer_api.c", 198));
