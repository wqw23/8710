#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\websocket/libwsclient.h"
...
#line 7 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\websocket/wsclient_api.h"
...
void ws_setCrt(char *pszCrt, int iCrtLen);
#line 8 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
#line 1 "D:\\1\\IAR\\arm\\inc\\c\\stdio.h"
...
#line 9 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"
#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.h"



void example_wsclient(void);

#line 10 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\websocket\\example_wsclient.c"

void handle_message(wsclient_context *wsclient, int data_len)
{
        rtl_printf("\r\n>>>>>> Receiving: %s with length: %d\n", wsclient->receivedData, data_len);

	if(prvStrCmp((const unsigned char *) wsclient->receivedData, (const unsigned char *) "hello") == 0)
		ws_send("world", prvStrLen((const unsigned char *) "world"), 1, wsclient);
	else if (prvStrCmp((const unsigned char *) wsclient->receivedData, (const unsigned char *) "world") == 0){
		ws_close(wsclient);
		wsclient = 0;
    }
}
...
static void example_wsclient_thread(void *param)
{
	...
	wsclient_context *wsclient = create_wsclient("wss://sandbox.kaazing.net", 0, "echo", 0, 1500);
	if(wsclient != 0){
		...
		if(ret >= 0){
			ws_send("hello", prvStrLen((const unsigned char *) "hello"), 1, wsclient);
...
void example_wsclient(void)
{
	if(xTaskGenericCreate( ( example_wsclient_thread ), ( ((const char*)"example_wsclient_thread") ), ( 1024 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
