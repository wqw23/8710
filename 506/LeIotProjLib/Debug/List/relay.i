#line 1 "D:\\vm-share\\506\\driver\\relay.c"
...
#line 5 "D:\\vm-share\\506\\driver\\relay.c"
...
#line 6 "D:\\vm-share\\506\\driver\\relay.c"
...
#line 8 "D:\\vm-share\\506\\driver\\relay.c"
...
#line 10 "D:\\vm-share\\506\\driver\\relay.c"
...
#line 11 "D:\\vm-share\\506\\driver\\relay.c"

#line 1 "D:\\vm-share\\506\\driver\\relay.h"
...
#line 13 "D:\\vm-share\\506\\driver\\relay.c"
...
#line 14 "D:\\vm-share\\506\\driver\\relay.c"

static struct relay_gpio_info  g_relay_gpio_info;

void relay_init(struct relay_gpio_info relay_init_info){
    do{if(g_log_level >= 0) {printf("[D]%s" "JDQ" ": " "relay driver init \n",rtos_time_print());}}while(0);
    g_relay_gpio_info = relay_init_info;
    gpio_init(&g_relay_gpio_info.gpio_relay, g_relay_gpio_info.relay_pin_num);
    gpio_dir(&g_relay_gpio_info.gpio_relay, g_relay_gpio_info.relay_pin_directionc);    
    gpio_mode(&g_relay_gpio_info.gpio_relay, g_relay_gpio_info.relay_pin_mode);         
...
void relay_trigger( UINT8 enable ){
    if(enable){
        ...
        do{if(g_log_level >= 0) {printf("[D]%s" "JDQ" ": " "Turn on JDQ \n",rtos_time_print());}}while(0);
    }else{
        gpio_write(&g_relay_gpio_info.gpio_relay, g_relay_gpio_info.jdq_off);
        do{if(g_log_level >= 0) {printf("[D]%s" "JDQ" ": " "Turn off JDQ \n",rtos_time_print());}}while(0);
    }
}
