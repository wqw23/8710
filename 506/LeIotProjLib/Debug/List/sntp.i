...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.h"
...
#line 142 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
...
struct tm sntp_gen_system_time(int timezone)
{
	...
	if(update_tick) {
		...
		tick_diff_sec = (current_tick - update_tick) / ( ( uint32_t ) 1000 );
		tick_diff_ms = (current_tick - update_tick) % ( ( uint32_t ) 1000 ) / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) );
		update_sec += tick_diff_sec;
		update_usec += (tick_diff_ms * 1000);
		current_sec = update_sec + update_usec / 1000000 + timezone * 3600;
	}
	else {
		current_sec = current_tick / ( ( uint32_t ) 1000 );
	}
...
int sntp_set_timeserver( unsigned int ntp_server_addr )
{
	...
	server_addr.addr = lwip_htonl(ntp_server_addr);
	_memset(str_addr, 0, sizeof(str_addr));
	if(ipaddr_ntoa_r(&server_addr, str_addr, 16) == 0)
		return -1;
...
#line 223 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
...
#line 269 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
...
#line 316 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
...
static char* sntp_server_addresses[] = {"iottimev1.lenovo.com.cn"};
...
sntp_process(u32_t *receive_timestamp)
{
  ...
  time_t t = (lwip_ntohl(receive_timestamp[0]) - (2208988800UL));


  u32_t us = lwip_ntohl(receive_timestamp[1]) / 4295;
  do { sntp_update_tick = xTaskGetTickCount(); sntp_update_sec = t; sntp_update_usec = us; } while(0);
   
  do { if ( (((0x00U | 0x40U)) & 0x80U) && (((0x00U | 0x40U)) & 0x80U) && ((s16_t)(((0x00U | 0x40U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_process: %s, %" "d" " us", ctime(&t), us); if (((0x00U | 0x40U)) & 0x08U) { while(1); } } } while(0);

#line 377 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
}
...
#line 400 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
}
...
sntp_retry(void* arg)
{
  ...
  do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_retry: Next request will be sent in %" "d" " ms\n", sntp_retry_timeout); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);


   
  sys_timeout(sntp_retry_timeout, sntp_request, 0);
...
#line 461 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
...
sntp_recv(void *arg, struct udp_pcb* pcb, struct pbuf *p, ip_addr_t *addr, u16_t port)
{
  ...
  sys_untimeout(sntp_retry, 0);
  sys_untimeout(sntp_request, 0);
    ...
    if (p->tot_len == 48) {
      ...
      if ((mode == 0x04) ||
        ...
        if (stratum == 0x00) {
          ...
          err = 1;
          do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_recv: Received Kiss-of-Death\n"); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
        } else {
#line 514 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\sntp\\sntp.c"
           
          {
             
            err = 0;
            pbuf_copy_partial(p, &receive_timestamp, 2 * 4, 32);
          }
        }
      } else {
        do { if ( (((0x00U | 0x01)) & 0x80U) && (((0x00U | 0x01)) & 0x80U) && ((s16_t)(((0x00U | 0x01)) & 0x03) >= 0x00)) { rtl_printf ("sntp_recv: Invalid mode in response: %" "d" "\n", (u16_t)mode); if (((0x00U | 0x01)) & 0x08U) { while(1); } } } while(0);
      }
    } else {
      do { if ( (((0x00U | 0x01)) & 0x80U) && (((0x00U | 0x01)) & 0x80U) && ((s16_t)(((0x00U | 0x01)) & 0x03) >= 0x00)) { rtl_printf ("sntp_recv: Invalid packet length: %" "d" "\n", p->tot_len); if (((0x00U | 0x01)) & 0x08U) { while(1); } } } while(0);
    }
  }
  pbuf_free(p);
  if (err == 0) {
    ...
    sys_timeout((u32_t)3600000, sntp_request, 0);
    do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_recv: Scheduled next time request: %" "d" " ms\n", (u32_t)3600000); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
...
sntp_send_request(ip_addr_t *server_addr)
{
  ...
  if (p != 0) {
    ...
    do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_send_request: Sending request to server\n"); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
    ...
    sys_timeout((u32_t)3000, sntp_retry, 0);




  } else {
    do { if ( (((0x00U | 0x02)) & 0x80U) && (((0x00U | 0x02)) & 0x80U) && ((s16_t)(((0x00U | 0x02)) & 0x03) >= 0x00)) { rtl_printf ("sntp_send_request: Out of memory, trying again in %" "d" " ms\n", (u32_t)3000); if (((0x00U | 0x02)) & 0x08U) { while(1); } } } while(0);

     
    sys_timeout((u32_t)3000, sntp_request, 0);
  }
}
...
sntp_dns_found(const char* hostname, ip_addr_t *ipaddr, void *arg)
{
  ...
  if (ipaddr != 0) {
    ...
    do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_dns_found: Server address resolved, sending request\n"); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
    sntp_send_request(ipaddr);
  } else {
     
    do { if ( (((0x00U | 0x01 | 0x20U)) & 0x80U) && (((0x00U | 0x01 | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x01 | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_dns_found: Failed to resolve server address resolved, trying next server\n"); if (((0x00U | 0x01 | 0x20U)) & 0x08U) { while(1); } } } while(0);
    sntp_retry(0);
  }
}
...
sntp_request(void *arg)
{
  ...
  err = dns_gethostbyname(sntp_server_addresses[0], &sntp_server_address,
    sntp_dns_found, 0);
  if (err == -5) {
     
    do { if ( (((0x00U | 0x20U)) & 0x80U) && (((0x00U | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_request: Waiting for server address to be resolved.\n"); if (((0x00U | 0x20U)) & 0x08U) { while(1); } } } while(0);
    return;
  }
  ...
  if (err == 0) {
    ...
    do { if ( (((0x00U | 0x01 | 0x20U)) & 0x80U) && (((0x00U | 0x01 | 0x20U)) & 0x80U) && ((s16_t)(((0x00U | 0x01 | 0x20U)) & 0x03) >= 0x00)) { rtl_printf ("sntp_request: Invalid server address, trying next server.\n"); if (((0x00U | 0x01 | 0x20U)) & 0x08U) { while(1); } } } while(0);
    sys_timeout((u32_t)3000, sntp_retry, 0);
  }
}
...
sntp_init(void)
{
  if (sntp_pcb == 0) {
    sntp_retry_timeout = 3000;
    sntp_pcb = udp_new();
    do { if(!(sntp_pcb != 0)) ; } while(0);
    if (sntp_pcb != 0) {
      udp_recv(sntp_pcb, sntp_recv, 0);
