#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 6 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 89 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
rtw_packet_filter_info_t paff_array[5]={0, 0, 0, 0, 0};
...
int promisc_add_packet_filter(uint8_t filter_id, rtw_packet_filter_pattern_t *patt, rtw_packet_filter_rule_t rule)
{
	...
	_memcpy(paff_array[i]. patt . mask, patt->mask, patt->mask_size);
	paff_array[i].patt.pattern= pvPortMalloc(patt->mask_size);
	_memcpy(paff_array[i]. patt . pattern, patt->pattern, patt->mask_size);
...
static void promisc_callback(unsigned char *buf, unsigned int len, void* userdata)
{
	...
	if(frame) {
		frame->prev = 0;
		frame->next = 0;
		_memcpy(frame ->da, buf, 6);
		_memcpy(frame ->sa, buf+6, 6);
		frame->len = len;
...
#line 304 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
...
#line 321 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
	}

	wifi_set_promisc(RTW_PROMISC_DISABLE, 0, 0);

	while((frame = retrieve_frame()) != 0)
		vPortFree((void *) frame);
}
		...
		while(1) {
			...
			if((current_time - start_time) < (duration * ( ( uint32_t ) 1000 ))) {
				...
				if(frame) {
					...
					rtl_printf(", len=%d", frame->len);
					rtl_printf(", RSSI=%d", frame->rssi);
#line 409 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
					vPortFree((void *) frame);
				}
				else
					vTaskDelay(1);	
...
#line 426 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
	}
...
{
	int duration;
#line 445 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
	wifi_init_packet_filter();

	if((argc == 2) && ((duration = prvAtoi(argv[1])) > 0))
		
		promisc_test_all(duration, 0);
	else if((argc == 3) && ((duration = prvAtoi(argv[1])) > 0) && (prvStrCmp((const unsigned char *) argv[2], (const unsigned char *) "with_len") == 0))
		promisc_test(duration, 1);
	else
		rtl_printf("\n\rUsage: %s DURATION_SECONDS [with_len]", argv[0]);
#line 460 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_promisc.c"
}
