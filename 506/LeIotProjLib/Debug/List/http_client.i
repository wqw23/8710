#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\utilities\\http_client.c"
...
#line 6 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\utilities\\http_client.c"
...
#line 8 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\utilities\\http_client.c"
...
char *http_post_header(char *host, char *resource, char *type, int data_len)
{
	...
	char *header = (char *) http_malloc(prvStrLen((const unsigned char *) "POST ") + prvStrLen((const unsigned char *) resource) + prvStrLen((const unsigned char *) " HTTP/1.1\r\nHost: ") + prvStrLen((const unsigned char *) host) + 
		prvStrLen((const unsigned char *) "\r\nContent-Type: ") + prvStrLen((const unsigned char *) type) + prvStrLen((const unsigned char *) "\r\nContent-Length: ") + prvStrLen((const unsigned char *) len_str) + prvStrLen((const unsigned char *) "\r\n\r\n") + 1);
	rtl_sprintf(header, "POST %s HTTP/1.1\r\nHost: %s\r\nContent-Type: %s\r\nContent-Length: %s\r\n\r\n", resource, host, type, len_str);
	http_free(len_str);
...
{
	char *header = (char *) http_malloc(prvStrLen((const unsigned char *) "GET ") + prvStrLen((const unsigned char *) resource) + prvStrLen((const unsigned char *) " HTTP/1.1\r\nHost: ") + prvStrLen((const unsigned char *) host) + prvStrLen((const unsigned char *) "\r\n\r\n") + 1);
	rtl_sprintf(header, "GET %s HTTP/1.1\r\nHost: %s\r\n\r\n", resource, host);
...
{
	char *http_response, *http_body = 0, *body_start;
	int body_len;
	...
	if(_strncmp(http_response, "HTTP", 4) == 0) {
		if((body_start = (char *)http_strstr(http_response, "\r\n\r\n")) != 0) {
			...
			if(body_len > 0) {
				...
				_memcpy(http_body, body_start, body_len);
