#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\sys_api.c"
...
#line 23 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\sys_api.c"
...
#line 47 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\device.h"

#line 33 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal_ext\\sys_api.h"
...
#line 24 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\sys_api.c"
...
#line 25 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\sys_api.c"
...
#line 26 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\sys_api.c"
...
void sys_clear_ota_signature(void)
{
	...
	uint32_t part2_offset = 0;
	uint32_t ota1_valid = 0;
	uint32_t ota2_valid = 0;
	uint8_t signature[8+1] = {0};

	part1_offset = (0xB020 - 0x20);
	flash_stream_read(&flash, part1_offset, 8, signature);
	if(!_memcmp((char const*)signature, "81958711", 8)){
		ota1_valid = 1;
	}

	DiagPrintf("\n\rOTA ota1_signature = %s \n", signature);
	
	flash_stream_read(&flash, 0x9000, 4, (uint8_t*)&part2_offset);
	flash_stream_read(&flash, (part2_offset -0x08000000) , 8, signature);
	if(!_memcmp((char const*)signature, "81958711", 8)){
		ota2_valid = 1;
	}
	...
	if ((ota1_valid == 1) && (ota2_valid == 1)) {
		uint32_t ValidIMG2 = ((uint32_t)(*((volatile uint32_t*)(0x08000000 + 0x9000 + 4))));
		uint32_t BitIdx = 0;

		if (ValidIMG2 == 0x00000000) {
			FLASH_EreaseDwordsXIP((0x9000 + 4), 1);
			ValidIMG2 = 0xFFFFFFFF;
		}
		
		for (BitIdx = 0; BitIdx <= 31; BitIdx++) {
			if ((ValidIMG2 & (1<<(BitIdx))) != 0) {
				break;
			}
		}
		...
		FLASH_TxData12BXIP((0x9000 + 4), 4, (uint8_t*)&ValidIMG2);
	}
}
...
void sys_log_uart_on(void)
{
	...
	if (((uint32_t)(*((volatile uint32_t*)(0x40000000 + 0x0038)))) & (0x00000001 << 14)) {
		PINMUX_Ctrl((8), (0), 1);
	} else {
		PINMUX_Ctrl((8), (1), 1);
	}
...
void sys_adc_calibration(uint8_t write, uint16_t *offset, uint16_t *gain)
{
	...
	flash_data = (uint32_t)*offset;
	flash_data |= (uint32_t)((*gain) << 16);
		
	if(write){
		FLASH_EreaseDwordsXIP((0x9000 + 0x200), 1);
		FLASH_TxData12BXIP((0x9000 + 0x200), 4, (uint8_t*)&flash_data);

		DiagPrintf("\n\rStore ADC calibration success.");
	}

	flash_stream_read(&flash, (0x9000 + 0x200), 4, (uint8_t*)&flash_data);
...
void sys_reset(void)
{
	...
	((*((volatile uint32_t*)(0x40000000 + 0x0014))) = ((uint32_t)(0x00000021)));
	DelayUs(100*1000);
...
void sys_cpu_reset(void)
{
	...
	reg_value = ((uint32_t)(*((volatile uint32_t*)(0x40000000 + 0x0210))));
	reg_value |= (1<<(27));
	((*((volatile uint32_t*)(0x40000000 + 0x0210))) = ((uint32_t)(reg_value)));
...
uint32_t sys_get_rdp_valid(void)
{
