#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"
...
#line 26 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\httpd/httpd.h"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"



#line 16 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"
...
void homepage_cb(struct httpd_conn *conn)
{
	...
	if(httpd_request_is_method(conn, "GET")) {
		char *body = "<HTML><BODY>" "It Works<BR>" "<BR>" "Can test GET by <A href=\"/test_get?test1=one%20%26%202&test2=three%3D3\">/test_get?test1=one%20%26%202&test2=three%3D3</A><BR>" "Can test POST by UI in <A href=\"/test_post.htm\">/test_post.htm</A><BR>" "</BODY></HTML>";
#line 39 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"

		
		httpd_response_write_header_start(conn, "200 OK", "text/html", prvStrLen((const unsigned char *) body));
		httpd_response_write_header(conn, "Connection", "close");
		httpd_response_write_header_finish(conn);
		httpd_response_write_data(conn, body, prvStrLen((const unsigned char *) body));
	}
	else {
		
		httpd_response_method_not_allowed(conn, 0);
	}
	...
	if(httpd_request_is_method(conn, "GET")) {
		...
		if((httpd_request_get_query_key(conn, "test1", &test1) != -1) &&
		   (httpd_request_get_query_key(conn, "test2", &test2) != -1)) {
			...
			httpd_response_write_header(conn, "Connection", "close");
			httpd_response_write_header_finish(conn);
			httpd_response_write_data(conn, "\r\nGET query string", prvStrLen((const unsigned char *) "\r\nGET query string"));
			httpd_response_write_data(conn, "\r\ntest1: ", prvStrLen((const unsigned char *) "\r\ntest1: "));
			httpd_response_write_data(conn, test1, prvStrLen((const unsigned char *) test1));
			httpd_response_write_data(conn, "\r\ntest2: ", prvStrLen((const unsigned char *) "\r\ntest2: "));
			httpd_response_write_data(conn, test2, prvStrLen((const unsigned char *) test2));
		}
		else {
...
void test_post_htm_cb(struct httpd_conn *conn)
{
	...
	if(httpd_request_is_method(conn, "GET")) {
		char *body = "<HTML><BODY>" "<FORM action=\"/test_post\" method=\"post\">" "Text1: <INPUT type=\"text\" name=\"text1\" size=\"50\" maxlength=\"50\"><BR>" "Text2: <INPUT type=\"text\" name=\"text2\" size=\"50\" maxlength=\"50\"><BR>" "<INPUT type=\"submit\" value=\"POST\"><BR>" "</FORM>" "</BODY></HTML>";
#line 105 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"
...
void test_post_cb(struct httpd_conn *conn)
{
	...
	if(httpd_request_is_method(conn, "POST")) {
		...
		uint8_t *body = (uint8_t *) pvPortMalloc(content_len + 1);

		if(body) {
			
			_memset(body, 0, content_len + 1);
			...
			rtl_sprintf(buf, "%d bytes from POST: ", read_size);
			httpd_response_write_data(conn, buf, prvStrLen((const unsigned char *) buf));
			httpd_response_write_data(conn, body, prvStrLen((const unsigned char *) body));
			vPortFree(body);
		}
		else {
			
			httpd_response_internal_server_error(conn, 0);
		}
	}
	else {
...
{
#line 169 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpd\\example_httpd.c"
	...
	if(httpd_start(80, 5, 4096, 0, 0) != 0) {

		rtl_printf("ERROR: httpd_start");
...
{
	if(xTaskGenericCreate( ( example_httpd_thread ), ( ((const char*)"example_httpd_thread") ), ( 2048 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
