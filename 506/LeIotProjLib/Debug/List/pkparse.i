...
#line 537 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/pk.h"

#line 593 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/pk.h"
...
#line 627 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/pk.h"
...
#line 94 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/asn1.h"
...
#line 48 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 497 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\pkparse.c"
                          ...
                          pk_type_t *pk_alg, asn1_buf *params )
{
    ...
    _memset(params, 0, sizeof(asn1_buf));
                        ...
                        pk_context *pk )
{
    ...
    if( ( pk_info = pk_info_from_type( pk_alg ) ) == 0 )
        return( -0x2C80 );
    ...
    if( pk_alg == POLARSSL_PK_RSA )
    {
        ret = pk_get_rsapubkey( p, end, ( (rsa_context *) (*pk). pk_ctx ) );
    } else
#line 623 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\pkparse.c"
        ret = -0x2C80;
...
#line 838 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\pkparse.c"
                                    ...
                                    size_t keylen )
{
    ...
    if( ( ret = asn1_get_tag( &p, end, &len, 0x04 ) ) != 0 )
        return( -0x2D00 + ret );
    ...
    if( pk_alg == POLARSSL_PK_RSA )
    {
        if( ( ret = pk_parse_key_pkcs1_der( ( (rsa_context *) (*pk). pk_ctx ), p, len ) ) != 0 )
        {
            pk_free( pk );
            return( ret );
        }
    } else
#line 922 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\pkparse.c"
        return( -0x2C80 );
...
#line 1038 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\pkparse.c"
    {
        ((void) pwd);
    }
                  ...
                  const unsigned char *pwd, size_t pwdlen )
{
    ...
    if( ret == 0 )
    {
        if( ( pk_info = pk_info_from_type( POLARSSL_PK_RSA ) ) == 0 )
            return( -0x2C80 );

        if( ( ret = pk_init_ctx( pk, pk_info                    ) ) != 0 ||
            ( ret = pk_parse_key_pkcs1_der( ( (rsa_context *) (*pk). pk_ctx ),
...
#line 1143 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\pkparse.c"
    ...
    if( ( ret = pk_init_ctx( pk, pk_info                           ) ) != 0 ||
        ( ret = pk_parse_key_pkcs1_der( ( (rsa_context *) (*pk). pk_ctx ), key, keylen ) ) == 0 )
    {
        return( 0 );
    }
...
#line 1259 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\pkparse.c"
