#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c"
...
#line 18 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c"
...
#line 29 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal\\i2c_api.h"
...
#line 20 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c"
...
#line 22 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c"
...
void i2c_send_restart(I2C_TypeDef *I2Cx, uint8_t* pBuf, uint8_t len, uint8_t restart);
...
uint8_t I2C_MasterRead_Patch(I2C_TypeDef *I2Cx, uint8_t* pBuf, uint8_t len)
{
	uint8_t cnt = 0;
	 
	(((((I2Cx) == ((I2C_TypeDef *) 0x40044000)) || ((I2Cx) == ((I2C_TypeDef *) 0x40044400)))) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c", 50));
	...
	for(cnt = 0; cnt < len; cnt++) {
		...
		while((I2C_CheckFlagState(I2Cx, ((uint32_t)0x00000001 << 3))) == 0) {
			if(I2C_GetRawINT(I2Cx) & ((uint32_t)0x00000001 << 6)) {
				do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" " TX_ABRT\n");}while(0);
...
uint8_t I2C_MasterWrite_Patch(I2C_TypeDef *I2Cx, uint8_t* pBuf, uint8_t len)
{
	uint8_t cnt = 0;
	uint8_t temp = 0;
	 
	(((((I2Cx) == ((I2C_TypeDef *) 0x40044000)) || ((I2Cx) == ((I2C_TypeDef *) 0x40044400)))) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c", 86));
	
	 
	for(cnt = 0; cnt < len; cnt++)
	{
		while((I2C_CheckFlagState(I2Cx, ((uint32_t)0x00000001 << 1))) == 0);
		...
		while((I2C_CheckFlagState(I2Cx, ((uint32_t)0x00000001 << 2))) == 0) {
			if(I2C_GetRawINT(I2Cx) & ((uint32_t)0x00000001 << 6)) {
				do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" " TX_ABRT\n");}while(0);
				I2C_ClearAllINT(I2Cx);
				return cnt;
...
int I2C_MasterRead_TimeOut(I2C_TypeDef *I2Cx, uint8_t* pBuf, uint8_t len, uint32_t timeout_ms)
{
	int cnt = 0;
	uint32_t InTimeoutCount = 0;
	
	 
	(((((I2Cx) == ((I2C_TypeDef *) 0x40044000)) || ((I2Cx) == ((I2C_TypeDef *) 0x40044400)))) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c", 127));
	...
	for(cnt = 0; cnt < len; cnt++) {
		...
		while((I2C_CheckFlagState(I2Cx, ((uint32_t)0x00000001 << 3))) == 0) {
			...
			if (InTimeoutCount == 0) {
				do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "MasterRead_TimeOut\n");}while(0);
				return cnt;
			}
			InTimeoutCount--;
		}
...
int I2C_MasterWrite_TimeOut(I2C_TypeDef *I2Cx, uint8_t* pBuf, uint8_t len, uint32_t timeout_ms)
{
	int cnt = 0;
	uint32_t InTimeoutCount = 0;

	 
	(((((I2Cx) == ((I2C_TypeDef *) 0x40044000)) || ((I2Cx) == ((I2C_TypeDef *) 0x40044400)))) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c", 177));
	...
	for(cnt = 0; cnt < len; cnt++)
	{
		...
		while((I2C_CheckFlagState(I2Cx, ((uint32_t)0x00000001 << 2))) == 0) {
			...
			if (InTimeoutCount == 0) {
				do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "MasterWrite_TimeOut\n");}while(0);
				return cnt;
			}
			InTimeoutCount--;
		}
...
int I2C_MasterSendNullData_TimeOut(I2C_TypeDef *I2Cx, int address, uint32_t timeout_ms) 
{
...
{
	if ((sda == (0x04)) || (sda == (0x13))|| (sda == (0x1E))) {
		return 0;
	} else if ((sda == (0x02)) || (sda == (0x17))|| (sda == (0x1B))) {
		return 1;
	} else {
		((0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c", 259));
	}
	return 2;
}
...
void i2c_init(i2c_t *obj, PinName sda, PinName scl) 
{
	...
	ConfigDebugErr &= (~(0x00000010|0x00000002));
	ConfigDebugInfo&= (~(0x00000010|0x00000002));

	do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "i2c_idx:%x\n",i2c_idx);}while(0);
	...
	I2CInitDat[obj->i2c_idx].I2CMaster     = ((uint32_t)0x00000001);
	I2CInitDat[obj->i2c_idx].I2CSpdMod     = ((uint32_t)0x00000001);
	...
	if(I2CInitDat[obj->i2c_idx].I2CIdx == 0) {
		...
		RCC_PeriphClockCmd(((1<<(16)) | 2 << 30), ((1<<(0)) | (2<<29)), 1);
	} else {
		
		RCC_PeriphClockCmd(((1<<(17)) | 2 << 30), ((1<<(2)) | (2<<29)), 1);
	}
	 
	Pinmux_Config(sda, (5));
	Pinmux_Config(scl, (5));

	PAD_PullCtrl(sda, 0x02);               
	PAD_PullCtrl(scl, 0x02);
...
void i2c_frequency(i2c_t *obj, int hz) 
{
	...
	if (i2c_default_clk != i2c_user_clk) {
		...
		if (i2c_user_clk <= 100) {
			...
			I2CInitDat[obj->i2c_idx].I2CSpdMod = ((uint32_t)0x00000002);
		}
		else if (i2c_user_clk > 400) {
			I2CInitDat[obj->i2c_idx].I2CSpdMod = ((uint32_t)0x00000003);
		}
		else {
			I2CInitDat[obj->i2c_idx].I2CSpdMod = ((uint32_t)0x00000001);
		}
...
int i2c_read(i2c_t *obj, int address, char *data, int length, int stop) 
{
	uint32_t I2CInTOTcnt     = 0;
	uint32_t InTimeoutCount  = 0;
	uint32_t InStartCount    = 0;
...
int i2c_repeatread(i2c_t *obj, int address, uint8_t *pWriteBuf, int Writelen, uint8_t *pReadBuf, int Readlen) 
{
	...
	{
		while((I2C_CheckFlagState(obj->I2Cx, ((uint32_t)0x00000001 << 1))) == 0);
...
void i2c_send_restart(I2C_TypeDef *I2Cx, uint8_t* pBuf, uint8_t len, uint8_t restart)
{
	...
	(((((I2Cx) == ((I2C_TypeDef *) 0x40044000)) || ((I2Cx) == ((I2C_TypeDef *) 0x40044400)))) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2c_api.c", 585));
...
void i2c_restart_enable(i2c_t *obj)
{
	...
	if (obj->I2Cx->IC_ENABLE & ((uint32_t)0x00000001)) {
		I2C_Cmd(obj->I2Cx, 0);
		i2cen = 1;
	}

	obj->I2Cx->IC_CON |= ((uint32_t)0x00000001 << 5);
...
void i2c_slave_mode(i2c_t *obj, int enable_slave) 
{
	...
	I2CInitDat[obj->i2c_idx].I2CMaster = ((uint32_t)0x00000001);
	if (enable_slave) 
		I2CInitDat[obj->i2c_idx].I2CMaster = ((uint32_t)0x00000000);
...
int i2c_slave_receive(i2c_t *obj) 
{
	uint32_t I2CLocalTemp = I2C_GetRawINT(obj->I2Cx);

	if (I2CLocalTemp & ((uint32_t)0x00000001 << 11)) {
		return 2;
	}
	else if (I2CLocalTemp & ((uint32_t)0x00000001 << 5)) {
		return 1;
	}

	if (I2C_CheckFlagState(obj->I2Cx, ((uint32_t)0x00000001 << 3))) {
		return 3;
	}
        return 0;
}
...
{
	if (set) {
		I2C_INTConfig(obj->I2Cx, ((uint32_t)0x00000001 << 5), 1);
	} else {
		I2C_INTConfig(obj->I2Cx, ((uint32_t)0x00000001 << 5), 0);
	}
...
int i2c_slave_set_for_data_nak(i2c_t *obj, int set_nak)
{
	...
	while (1) {
		...
		if ((((uint32_t)0x00000001 << 6) & temp) == 0) {
			break;
		}
	}
