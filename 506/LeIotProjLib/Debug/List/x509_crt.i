...
#line 193 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/x509_crt.h"
...
#line 271 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/x509_crt.h"

#line 289 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/x509_crt.h"

#line 302 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/x509_crt.h"
...
#line 553 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/x509_crt.h"
...
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 84 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 127 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 163 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 223 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 252 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 269 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 470 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 565 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/oid.h"
...
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/pem.h"
...
#line 128 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/pem.h"
...
#line 95 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/platform.h"



 
#line 113 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/platform.h"



 
#line 125 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/platform.h"
                               ...
                               x509_sequence *ext_key_usage)
{
    ...
    if( ( ret = asn1_get_sequence_of( p, end, ext_key_usage, 0x06 ) ) != 0 )
        return( -0x2500 + ret );
                                      ...
                                      x509_sequence *subject_alt_name )
{
    ...
    while( *p < end )
    {
        ...
        if( cur->buf.p != 0 )
        {
            cur->next = (asn1_sequence *) rom_ssl_ram_map . ssl_malloc(
            ...
            _memset(cur->next, 0, sizeof( asn1_sequence ));
            cur = cur->next;
        }
                             ...
                             x509_crt *crt )
{
    ...
    while( *p < end )
    {
        ...
        if( ( ret = asn1_get_tag( p, end, &extn_oid.len, 0x06 ) ) != 0 )
            return( -0x2500 + ret );
                                    ...
                                    size_t buflen )
{
    ...
    _memset(&sig_params1, 0, sizeof( x509_buf ));
    _memset(&sig_params2, 0, sizeof( x509_buf ));
    ...
    p = (unsigned char *) rom_ssl_ram_map . ssl_malloc( len = buflen );

    if( p == 0 )
        return( -0x2880 );

    _memcpy(p, buf, buflen);
    ...
    if( crt->sig_oid1.len != crt->sig_oid2.len ||
        _memcmp(crt->sig_oid1 . p, crt->sig_oid2 . p, crt->sig_oid1 . len) != 0 ||
        sig_params1.len != sig_params2.len ||
        _memcmp(sig_params1 . p, sig_params2 . p, sig_params1 . len) != 0 )
    {
        x509_crt_free( crt );
        return( -0x2680 );
    }
                        ...
                        size_t buflen )
{
    ...
    {
        crt->next = (x509_crt *) rom_ssl_ram_map . ssl_malloc( sizeof( x509_crt ) );
...
int x509_crt_parse( x509_crt *chain, const unsigned char *buf, size_t buflen )
{
    ...
    if( prvStrStr((const char *) buf, "-----BEGIN CERTIFICATE-----") != 0 )
        buf_format = 2;
...
#line 1117 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509_crt.c"



#line 1133 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509_crt.c"
...
#line 1178 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509_crt.c"
                                ...
                                unsigned char ns_cert_type )
{
    ...
    if( ns_cert_type & (0x80) ) { ret = rtl_snprintf( p, n, "%s" "SSL Client", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( ns_cert_type & (0x40) ) { ret = rtl_snprintf( p, n, "%s" "SSL Server", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( ns_cert_type & (0x20) ) { ret = rtl_snprintf( p, n, "%s" "Email", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( ns_cert_type & (0x10) ) { ret = rtl_snprintf( p, n, "%s" "Object Signing", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( ns_cert_type & (0x08) ) { ret = rtl_snprintf( p, n, "%s" "Reserved", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( ns_cert_type & (0x04) ) { ret = rtl_snprintf( p, n, "%s" "SSL CA", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( ns_cert_type & (0x02) ) { ret = rtl_snprintf( p, n, "%s" "Email CA", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( ns_cert_type & (0x01) ) { ret = rtl_snprintf( p, n, "%s" "Object Signing CA", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
                                ...
                                unsigned char key_usage )
{
    ...
    if( key_usage & (0x80) ) { ret = rtl_snprintf( p, n, "%s" "Digital Signature", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( key_usage & (0x40) ) { ret = rtl_snprintf( p, n, "%s" "Non Repudiation", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( key_usage & (0x20) ) { ret = rtl_snprintf( p, n, "%s" "Key Encipherment", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( key_usage & (0x10) ) { ret = rtl_snprintf( p, n, "%s" "Data Encipherment", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( key_usage & (0x08) ) { ret = rtl_snprintf( p, n, "%s" "Key Agreement", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( key_usage & (0x04) ) { ret = rtl_snprintf( p, n, "%s" "Key Cert Sign", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
    if( key_usage & (0x02) ) { ret = rtl_snprintf( p, n, "%s" "CRL Sign", sep ); { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; }; sep = ", "; };;
                                    ...
                                    const x509_sequence *extended_key_usage )
{
    ...
    while( cur != 0 )
    {
        ...
        ret = rtl_snprintf( p, n, "%s%s", sep, desc );
        { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; };
                   ...
                   const x509_crt *crt )
{
    ...
    ret = rtl_snprintf( p, n, "%scert. version     : %d\n",
                               prefix, crt->version );
    { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; };
    ret = rtl_snprintf( p, n, "%sserial number     : ",
                               prefix );
    { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; };
    ...
    if( ( ret = x509_key_size_helper( key_size_str, 18,
    ...
    if( crt->ext_types & (1 << 8) )
    {
        ...
        {
            ret = rtl_snprintf( p, n, ", max_pathlen=%d", crt->max_pathlen - 1 );
            { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; };
        }
    }
...
#line 1400 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509_crt.c"

#line 1432 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509_crt.c"

#line 1543 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509_crt.c"
...
{
    size_t i;
    size_t cn_idx = 0, cn_len = prvStrLen((const unsigned char *) cn);
                                  ...
                                  int top, int bottom )
{
    ...
    if( child->issuer_raw.len != parent->subject_raw.len ||
        _memcmp(child->issuer_raw . p, parent->subject_raw . p, child->issuer_raw . len) != 0 )
    ...
    if( top && bottom &&
        ...
        _memcmp(child->raw . p, parent->raw . p, child->raw . len) == 0 )
    {
        need_ca_bit = 0;
    }
...
#line 1646 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509_crt.c"
                ...
                void *p_vrfy )
{
    ...
    *flags |= 0x08;
    ...
    for(   ; trust_ca != 0; trust_ca = trust_ca->next )
    {
        ...
        if( child->subject_raw.len == trust_ca->subject_raw.len &&
            _memcmp(child->subject_raw . p, trust_ca->subject_raw . p, child->issuer_raw . len) == 0 )
                     ...
                     void *p_vrfy )
{
    ...
    *flags = 0;
    ...
    {
        name = &crt->subject;
        cn_len = prvStrLen((const unsigned char *) cn);
        ...
        else
        {
            while( name != 0 )
            {
                if( ( ( (sizeof("\x55" "\x04" "\x03") - 1) == (&name ->oid)->len ) && _memcmp(("\x55" "\x04" "\x03"), (&name ->oid)->p, (&name ->oid)->len) == 0 ) )
                {
    ...
    for( parent = crt->next; parent != 0; parent = parent->next )
    {
...
void x509_crt_free( x509_crt *crt )
{
    ...
    do
    {
        ...
        while( name_cur != 0 )
        {
            ...
            rom_ssl_ram_map . ssl_free( name_prv );
        }
        ...
        while( seq_cur != 0 )
        {
            ...
            rom_ssl_ram_map . ssl_free( seq_prv );
        }
        ...
        if( cert_cur->raw.p != 0 )
        {
            ...
            rom_ssl_ram_map . ssl_free( cert_cur->raw.p );
        }
    ...
    do
    {
        ...
        if( cert_prv != crt )
            rom_ssl_ram_map . ssl_free( cert_prv );
    }
    while( cert_cur != 0 );
}
