#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pinmap.c"
...
#line 11 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pinmap.c"
...
#line 12 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pinmap.c"
...
void pin_function(PinName pin, int function) 
{
	uint8_t dword_index = 0;
	uint8_t shift_bits = 0; 
	uint32_t Temp = 0;
	
	((pin != NC) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pinmap.c", 22));
	...
	Temp = ((PINMUX_TypeDef *) 0x40000280)->PADCTR[dword_index];
	...
	Temp |= ((function & 0xFF) | (1<<(8))) << shift_bits;  

	 
	((PINMUX_TypeDef *) 0x40000280)->PADCTR[dword_index] = Temp;
}
...
void pin_mode(PinName pin, PinMode mode) 
{
	...
	PAD_PullCtrl((uint32_t)pin, (uint32_t)pull_type);
