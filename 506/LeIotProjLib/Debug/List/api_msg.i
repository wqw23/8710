    ...
    ip_addr_t *addr)
{
  ...
  if ((conn != 0) && sys_mbox_valid(&conn->recvmbox)) {
#line 96 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_msg.c"
   ...
   ip_addr_t *addr, u16_t port)
{
  ...
  if (buf == 0) {
    ...
    buf->port = port;
#line 192 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_msg.c"
  }
...
poll_tcp(void *arg, struct tcp_pcb *pcb)
{
  ...
  if (conn->flags & 0x10) {
    ...
    if ((conn->pcb.tcp != 0) && (((conn->pcb . tcp)->snd_buf) > (((((((((5*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((5*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) < (((5*(1500 - 40))) - 1)) ? (((((((5*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((5*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) : (((5*(1500 - 40))) - 1))) &&
      (((conn->pcb . tcp)->snd_queuelen) < ((((((4* (5*(1500 - 40))/(1500 - 40)))/2)) > (5)) ? ((((4* (5*(1500 - 40))/(1500 - 40)))/2)) : (5)))) {
      conn->flags &= ~0x10;
...
accept_function(void *arg, struct tcp_pcb *newpcb, err_t err)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("accept_function: newpcb->tate: %s\n", tcp_debug_state_str(newpcb->state)); if ((0x00U) & 0x08U) { while(1); } } } while(0);

  if (!sys_mbox_valid(&conn->acceptmbox)) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("accept_function: acceptmbox already deleted\n"); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return -6;
  }
...
netconn_alloc(enum netconn_type t, netconn_callback callback)
{
  ...
  size = 6;
#line 611 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_msg.c"
    ...
    if (msg->conn->pcb.tcp != 0) {
      if (msg->conn->type == NETCONN_TCP) {
        if (msg->conn->state == NETCONN_NONE) {
          ...
          struct tcp_pcb* lpcb = tcp_listen_with_backlog(msg->conn->pcb . tcp, 0xff);
...
do_send(struct api_msg_msg *msg)
{
  if (((msg->conn->last_err) < -9)) {
    ...
    if (msg->conn->pcb.tcp != 0) {
      ...
      case NETCONN_UDP:
#line 1149 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_msg.c"
        if (((&msg->msg . b->addr) == 0 || (&msg->msg . b->addr)->addr == ((u32_t)0x00000000UL))) {
...
#line 1241 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_msg.c"
  {
...
err_mem:
      if (dontblock && (len < conn->current_msg->msg.w.len)) {
        ...
        conn->flags |= 0x10;
      } else if ((((conn->pcb . tcp)->snd_buf) <= (((((((((5*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((5*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) < (((5*(1500 - 40))) - 1)) ? (((((((5*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((5*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) : (((5*(1500 - 40))) - 1))) ||
                 (((conn->pcb . tcp)->snd_queuelen) >= ((((((4* (5*(1500 - 40))/(1500 - 40)))/2)) > (5)) ? ((((4* (5*(1500 - 40))/(1500 - 40)))/2)) : (5)))) {
...
#line 1371 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_msg.c"
...
do_dns_found(const char *name, ip_addr_t *ipaddr, void *arg)
{
  ...
  do { if(!(prvStrCmp((const unsigned char *) msg->name, (const unsigned char *) name) == 0)) ; } while(0);
  (void)name;
