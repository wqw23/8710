#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
...
#line 28 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_conf.h"
...
#line 33 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_conf.h"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
...
static event_list_elem_t     event_callback_list[WIFI_EVENT_MAX][3];





#line 67 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
static rtw_result_t rtw_indicate_event_handle(int event_cmd, char *buf, int buf_len, int flags)
{
	rtw_event_handler_t handle = 0;
	int i;
...
#line 114 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
			break;
		case WIFI_EVENT_FOURWAY_HANDSHAKE_DONE:
#line 123 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
			break;
...
#line 141 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
			break;
		...
		case WIFI_EVENT_RX_MGNT:
			...
			break;
#line 159 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
...
void wifi_reg_event_handler(unsigned int event_cmds, rtw_event_handler_t handler_func, void *handler_user_data)
{
	...
	if(event_cmds < WIFI_EVENT_MAX){
		for(i=0; i < 3; i++){
			if(event_callback_list[event_cmds][i].handler == 0){
			    for(j=0; j<3; j++){
	...
	if(event_cmds < WIFI_EVENT_MAX){
		for(i = 0; i < 3; i++){
			if(event_callback_list[event_cmds][i].handler == handler_func){
				event_callback_list[event_cmds][i].handler = 0;
				event_callback_list[event_cmds][i].handler_user_data = 0;
				return;
			}
		}
	}
...
void init_event_callback_list(){
	_memset(event_callback_list, 0, sizeof(event_callback_list));
}

int wifi_manager_init()
{
#line 254 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\api\\wifi\\wifi_ind.c"
	return 0;
}
