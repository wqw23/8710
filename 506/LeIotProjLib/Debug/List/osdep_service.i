#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
...
#line 8 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
...
uint32_t rtw_atoi(uint8_t* s)
{
	...
	for(i=0;i<=prvStrLen((const unsigned char *) (char *)s);i++)
	{
		if(s[i] >= '0' && s[i] <= '9')
			num = num * 10 + s[i] -'0';
		else if(s[0] == '-' && i==0) 
...
void deinit_mem_monitor(_list *pmem_table, int *used_num)
{
#line 192 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
}
...
void add_mem_usage(_list *pmem_table, void *ptr, int size, int *used_num, int flag)
{
	...
	if(ptr == 0) {
		rtl_printf("\n\r[%s] " "Catch a mem alloc fail with size of %d, current heap free size = %d", __FUNCTION__,size, free_heap_size);
		return;
	}
	else{
		if(flag == 0x2)
...
#line 228 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
...
void del_mem_usage(_list *pmem_table, void *ptr, int *used_num, int flag)
{
#line 268 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
}

#line 302 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
...
uint32_t rtw_down_sema(_sema *sema)
{
	while(rtw_down_timeout_sema(sema, 0xFFFFFFFF) != (!0))
...
#line 750 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
...
static void worker_thread_main( void *arg )
{
	...
	while ( 1 )
	{
		...
		if ( rtw_pop_from_xqueue( &worker_thread->event_queue, &message, 0xFFFFFFFF ) == 0 )
		{
...
int rtw_create_worker_thread( rtw_worker_thread_t* worker_thread, uint8_t priority, uint32_t stack_size, uint32_t event_queue_size )
{
	...
	_memset(worker_thread, 0, sizeof( *worker_thread ));

	if ( rtw_init_xqueue( &worker_thread->event_queue, "worker queue", sizeof(rtw_event_message_t), event_queue_size ) != 0 )
	{
		return (-1);
	}
...
#line 1280 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\os_dep\\osdep_service.c"
void rtw_thread_enter(char *name)
{
