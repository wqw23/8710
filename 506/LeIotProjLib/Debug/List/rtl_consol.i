#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\app\\monitor\\ram\\rtl_consol.c"
...
#line 11 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\app\\monitor\\ram\\rtl_consol.c"
...
#line 12 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\app\\monitor\\ram\\rtl_consol.c"
#include <stdarg.h>
...
#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\freertos_v8.1.2\\Source\\include\\timers.h"
...
#line 100 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\freertos_v8.1.2\\Source\\include\\timers.h"
...
#line 74 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\os\\freertos\\freertos_v8.1.2\\Source\\include\\event_groups.h"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\app\\monitor\\ram\\rtl_consol.c"


extern volatile UART_LOG_CTL    UartLogCtl;
extern volatile UART_LOG_CTL    *pUartLogCtl;
extern uint8_t                       *ArgvArray[10];
extern UART_LOG_BUF              UartLogBuf;

extern COMMAND_TABLE    UartLogRamCmdTable[];

extern uint8_t  UartLogHistoryBuf[5][127];



uint32_t		Consol_TaskRdy;
_sema	Consol_Sema;
...
#line 82 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\app\\monitor\\ram\\rtl_consol.c"
...
)
{
    ...
    if (UartReceiveData == 0x1B) {
        
        if (pUartLogCtl->ExecuteEsc != (!0))
        {
            pUartLogCtl->ExecuteEsc = (!0);
        ...
        if ((*pUartLogCtl).EscSTS==2){
            ...
            if (UartLogCmdChk(UartReceiveData,(UART_LOG_CTL *)pUartLogCtl,1)==2)
            {
                ...
                {
                    ArrayInitialize((uint8_t *)pUartLogCtl->pTmpLogBuf->UARTLogBuf, 127, '\0');
                }
            }
        }
    }
...
)
{
    ...
    ArrayInitialize(&UartLogBuf.UARTLogBuf[0],127,'\0');
    ...
    else
    {
        ...
        if (( ( BaseType_t ) 1 ) != xTaskGenericCreate( ( RtlConsolTaskRam ), ( (const char * const)"LOGUART_TASK" ), ( stack_size ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 5 ), ( 0 ), ( 0 ), ( 0 ) ))
        {
...
uint32_t console_cmd_exec(uint8_t  argc, uint8_t  **argv)
{
...
UartLogCmdExecuteRam(
	uint8_t  argc, uint8_t  **argv
){
	monitor_cmd_handler cmd_handler = 0;
...
)
{
	...
	do{
		...
		if (pUartLogCtl->ExecuteCmd) {
			...
			_strncpy(log_buf, (const uint8_t*)&(*pUartLogBuf).UARTLogBuf[0], 100-1);
			...
			if (argc > 0) {
				...
				ArrayInitialize(&(*pUartLogBuf).UARTLogBuf[0], 127, '\0');
			} else {
...
#line 465 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\app\\monitor\\ram\\rtl_consol.c"
...
{
	UART_INTConfig(((UART_TypeDef *) 0x40003000), ((uint32_t)0x00000001) | ((uint32_t)0x00000001<<2), 0);
	UART_RxCmd(((UART_TypeDef *) 0x40003000), 0);

	while (UART_Writable(((UART_TypeDef *) 0x40003000)) == 0);
	
	UART_SetBaud(((UART_TypeDef *) 0x40003000), BaudRate);
	
	UART_INTConfig(((UART_TypeDef *) 0x40003000), ((uint32_t)0x00000001) | ((uint32_t)0x00000001<<2), 1);
	UART_RxCmd(((UART_TypeDef *) 0x40003000), 1);
...
void LOGUART_SetBaud_FromFlash(void)
{
	SYSTEM_DATA *SysData = (SYSTEM_DATA *)(0x08000000 + 0x9000);

	 
	if (SysData->UlogRate != 0xFFFFFFFF) {
		do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "LOGUART_SetBaud %d \n\n", SysData->UlogRate);}while(0);
