#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 13 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 12 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect/example_wlan_fast_connect.h"
...
#line 13 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect/example_wlan_fast_connect.h"
...
#line 14 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect/example_wlan_fast_connect.h"
...
#line 14 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 17 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 18 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 20 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 21 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
#line 22 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\wlan_fast_connect\\example_wlan_fast_connect.c"
...
int wlan_wrtie_reconnect_data_to_flash(uint8_t *data, uint32_t len)
{
	...
	flash_stream_read(&flash, (0x80000 - 0x1000), sizeof(struct wlan_fast_reconnect), (uint8_t *) &read_data);
	...
	if(_memcmp(data, (uint8_t *) &read_data, sizeof(struct wlan_fast_reconnect)) != 0) {
	    rtl_printf("\r\n %s():not the same ssid/passphrase/channel, write new profile to flash", __func__);
	    flash_erase_sector(&flash, (0x80000 - 0x1000));
	    flash_stream_write(&flash, (0x80000 - 0x1000), len, (uint8_t *) data);
	}
...
int wlan_init_done_callback()
{
	...
	if(data){
		...
		if(empty_data){
			_memset(empty_data, 0xff, sizeof(struct wlan_fast_reconnect));
			if(_memcmp(empty_data, data, sizeof(struct wlan_fast_reconnect)) == 0){
				rtl_printf("[FAST_CONNECT] Fast connect profile is empty, abort fast connection\n");
				rtw_mfree(data);
		...
		rtl_sprintf(key_id,"%d",(char) (channel>>28));
		channel &= 0xff;
		...
		_strcpy((char *)wifi . ssid . val, (char*)psk_essid);
		wifi.ssid.len = prvStrLen((const unsigned char *) (char*)psk_essid);

		switch(security_type){
			case RTW_SECURITY_WEP_PSK:
				wifi.password = (unsigned char*) psk_passphrase;
				wifi.password_len = prvStrLen((const unsigned char *) (char*)psk_passphrase);
				wifi.key_id = prvAtoi((const char *)key_id);
				break;
		...
		ret = wifi_connect((char*)wifi.ssid.val, wifi.security_type, (char*)wifi.password, wifi.ssid.len,
			wifi.password_len, wifi.key_id, 0);
