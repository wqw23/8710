#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\nonblock_connect\\example_nonblock_connect.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\nonblock_connect\\example_nonblock_connect.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\nonblock_connect\\example_nonblock_connect.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\nonblock_connect\\example_nonblock_connect.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\nonblock_connect\\example_nonblock_connect.c"
...
static void example_nonblock_connect_thread(void *param)
{
	...
	server_fd = lwip_socket(2,1,0);
	lwip_fcntl(server_fd,4,lwip_fcntl(server_fd,3,0) | 1);

	server_addr.sin_family = 2;
	server_addr.sin_addr.s_addr = ipaddr_addr("192.168.13.1");
	server_addr.sin_port = lwip_htons(80);
	lwip_connect(server_fd,(struct sockaddr *) &server_addr,sizeof(server_addr));
	...
	if(errno == 115) {
		...
		time_out.tv_sec = 3;	
		time_out.tv_usec = 0;
		_memset((void*)(&wfds), 0, sizeof(*(&wfds))) ;
		((&wfds)->fd_bits[(server_fd)/8] |= (1 << ((server_fd) & 7)));	

		
		if(lwip_select(server_fd + 1,0,&wfds,0,&time_out) == 1)
			rtl_printf("Server connection successful\n");
		else
			rtl_printf("Server connection failed\n");
	}
	else {
...
{
	if(xTaskGenericCreate( ( example_nonblock_connect_thread ), ( ((const char*)"example_nonblock_connect_thread") ), ( 1024 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
