...
#line 70 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/x509.h"
...
#line 79 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"
...
#line 341 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"
                                     ...
                                     x509_name *cur )
{
    ...
    if( ( ret = asn1_get_tag( p, end, &oid->len, 0x06 ) ) != 0 )
        return( -0x2380 + ret );
                   ...
                   x509_name *cur )
{
    ...
    do
    {
        ...
        if( *p != end )
        {
            use->next = (x509_name *) rom_ssl_ram_map . ssl_malloc(
                    sizeof( x509_name ) );

            if( use->next == 0 )
                return( -0x2880 );

            _memset(use ->next, 0, sizeof( x509_name ));
    ...
    cur->next = (x509_name *) rom_ssl_ram_map . ssl_malloc(
         sizeof( x509_name ) );

    if( cur->next == 0 )
        return( -0x2880 );

    _memset(cur->next, 0, sizeof( x509_name ));
                   ...
                   x509_time *time )
{
    ...
    if( tag == 0x17 )
    {
        ...
        _memcpy(date, *p, ( len < sizeof( date ) - 1 ) ? len : sizeof( date ) - 1);
...
#line 595 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"
    {
...
#line 689 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"

#line 725 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"



#line 741 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"
...
int x509_dn_gets( char *buf, size_t size, const x509_name *dn )
{
    ...
    while( name != 0 )
    {
        ...
        if( ret == 0 )
            ret = rtl_snprintf( p, n, "%s=", short_name );
        else
            ret = rtl_snprintf( p, n, "\?\?=" );
        { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; };
                       ...
                       const void *sig_opts )
{
    ...
    if( ret != 0 )
        ...
        ret = rtl_snprintf( p, n, "%s", desc );
    { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; };

#line 874 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"
    ((void) pk_alg);
    ((void) md_alg);
    ((void) sig_opts);
...
int x509_key_size_helper( char *buf, size_t size, const char *name )
{
    ...
    if( prvStrLen((const unsigned char *) name) + sizeof( " key size" ) > size )
        return( -2 );

    ret = rtl_snprintf( p, n, "%s key size", name );
    { if( ret == -1 ) return( -1 ); if( (unsigned int) ret > n ) { p[n - 1] = '\0'; return( -2 ); } n -= (unsigned int) ret; p += (unsigned int) ret; };
...
#line 1016 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"
...
#line 1101 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\x509.c"
