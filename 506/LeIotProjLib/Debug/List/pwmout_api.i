#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pwmout_api.c"
...
#line 20 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pwmout_api.c"
...
#line 22 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pwmout_api.c"

#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal\\pwmout_api.h"
...
#line 24 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\pwmout_api.c"


uint32_t pin2chan[13][2] = {
	{PA_23, 0},
	{PA_15, 1},
	{PA_0  , 2},
	{PA_30, 3},
...
uint8_t timer5_start = 0;
uint8_t ch_start[6] = {0};
uint8_t prescaler = 0;
...
uint32_t pwmout_pin2chan(PinName pin)
{
	int i = 0;
	for(;i < 13;i++){
		if(pin2chan[i][0] == pin){
...
void pwmout_timer5_init(pwmout_t* obj)
{
	...
	RTIM_TimeBaseInit(((RTIM_TypeDef *) (0x40002000 + 0x140)), &TIM_InitStruct, TIMER5_IRQ, 0, (uint32_t)&TIM_InitStruct);
	RTIM_Cmd(((RTIM_TypeDef *) (0x40002000 + 0x140)), 1);
...
void pwmout_init(pwmout_t* obj, PinName pin) 
{
	...
	if(pwm_chan == NC)
		do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "PinName error: pwm channel of PinName doesn't exist!\n");}while(0);

	if(!timer5_start)
		pwmout_timer5_init(obj);

	RTIM_CCStructInit(&TIM_CCInitStruct);
	RTIM_CCxInit(((RTIM_TypeDef *) (0x40002000 + 0x140)), &TIM_CCInitStruct, pwm_chan);
	RTIM_CCxCmd(((RTIM_TypeDef *) (0x40002000 + 0x140)), pwm_chan, ((uint32_t)0x01000000));
...
void pwmout_free(pwmout_t* obj) 
{
	...
	if(ch_start[i]){
		ch_start[i] = 0;
		RTIM_CCxCmd(((RTIM_TypeDef *) (0x40002000 + 0x140)), obj->pwm_idx, ((uint32_t)0x00000000));
	}
	...
	RTIM_Cmd(((RTIM_TypeDef *) (0x40002000 + 0x140)), 0);
	timer5_start = 0;
...
void pwmout_write(pwmout_t* obj, float percent) 
{
	...
	ccrx = (uint32_t)(obj->pulse  * 40 / (prescaler + 1)) & 0x0000ffff;
	
	RTIM_CCRxSet(((RTIM_TypeDef *) (0x40002000 + 0x140)), ccrx, obj->pwm_idx);	
}
...
void pwmout_period_us(pwmout_t* obj, int us) 
{
	...
	uint32_t tmp = us * 40 / (prescaler + 1);

	if(tmp > 0x10000){
		prescaler = us * 40 / 0x10000;
		RTIM_PrescalerConfig(((RTIM_TypeDef *) (0x40002000 + 0x140)), prescaler, ((uint32_t)0x00000000));
	}

	obj->period = us;
	arr = us * 40 / (prescaler + 1) - 1;
	
	RTIM_ChangePeriod(((RTIM_TypeDef *) (0x40002000 + 0x140)), arr);
	pwmout_write(obj, dc);
}
...
{
	RTIM_CCxCmd(((RTIM_TypeDef *) (0x40002000 + 0x140)), obj->pwm_idx, ((uint32_t)0x01000000));
}
