#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\rtc_api.c"
...
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal\\rtc_api.h"
...
#line 29 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal\\rtc_api.h"
...
#line 30 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal\\rtc_api.h"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\rtc_api.c"

#line 1 "D:\\1\\IAR\\arm\\inc\\c\\time.h"
 
 
#line 198 "D:\\1\\IAR\\arm\\inc\\c\\time.h"
...
#line 21 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\rtc_api.c"
...
#line 22 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\rtc_api.c"
...
static void rtc_restore_timeinfo(void)
{
	...
	value = BKUP_Read(0);
	rtc_timeinfo.tm_year = (value & ((uint32_t)0x0000FF00)) >> 8;
...
{
	uint32_t value = BKUP_Read(0);
	value = (value & ~((uint32_t)0x0000FF00)) | (rtc_timeinfo.tm_year << 8);
...
void rtc_alarm_intr_handler(uint32_t data)
{
...
uint32_t rtc_set_alarm(alarm_t *alrm, alarm_irq_handler alarmHandler)
{
	...
	RTC_AlarmStruct_temp.RTC_AlarmTime.RTC_H12_PMAM = ((uint8_t)0x00);
	...
	RTC_AlarmStruct_temp.RTC_AlarmMask = ((uint32_t)0x00000000);
	RTC_AlarmStruct_temp.RTC_Alarm2Mask = ((uint32_t)0x00000000);

	RTC_SetAlarm(((uint32_t)0x000000000), &RTC_AlarmStruct_temp);

	RTC_AlarmCmd(1);
	VECTOR_IrqRegister((IRQ_FUN)rtc_alarm_intr_handler, RTC_IRQ, (uint32_t)alrm, 4);
	VECTOR_IrqEn(RTC_IRQ, 4);
...
void rtc_disable_alarm(void)
{
	VECTOR_IrqDis(RTC_IRQ);
	VECTOR_IrqUnRegister(RTC_IRQ);
	RTC_AlarmCmd(0);
