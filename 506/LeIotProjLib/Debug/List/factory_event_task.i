#line 1 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 5 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 6 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 7 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 8 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 10 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 6 "D:\\vm-share\\506\\LeIotProjLib\\..\\driver\\led.h"
...
#line 12 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 13 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 14 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 15 "D:\\vm-share\\506\\adapter\\factory_event_task.c"
...
#line 17 "D:\\vm-share\\506\\adapter\\factory_event_task.c"


extern uint8 pcba_factory_key_status;
extern int led_relay_onoff;  

void FactoryKeyEvent(int* m_dev_status)
{
    *m_dev_status = *m_dev_status ? 0 : 1;
    do{if(g_log_level >= 0) {printf("[D]%s"  "FactoryKeyEvent=====m_dev_status=%d,factory_led_relay_onoff=%d",rtos_time_print(),*m_dev_status,led_relay_onoff);}}while(0);
    if(*m_dev_status==0){
        led_relay_onoff = led_relay_onoff ? 0 : 1;
        if(PcbaIsKeyStatusHigh())
            pcba_factory_key_status=1;
        else
            SendKeyStatusToUDP(*m_dev_status);

        do{if(g_log_level >= 0) {printf("[D]%s"  "FactoryKeyEvent plug key action up \n",rtos_time_print());}}while(0);
        ...
        if(PcbaIsKeyStatusHigh())
            ...
            SendKeyStatusToUDP(*m_dev_status);
        do{if(g_log_level >= 0) {printf("[D]%s"  "FactoryKeyEvent plug key action down \n",rtos_time_print());}}while(0);
    }
