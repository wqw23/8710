#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\mdns\\example_mdns.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\mdns\\example_mdns.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\mdns\\example_mdns.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\mdns\\example_mdns.c"
...
#line 6 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\mdns\\example_mdns.c"
...
#line 8 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\mdns\\example_mdns.c"
...
static void example_mdns_thread(void *param)
{
	...
	if(mDNSResponderInit() == 0) {
		rtl_printf("mDNS Register service\n");
		TXTRecordCreate(&txtRecord, sizeof(txt_buf), txt_buf);
		TXTRecordSetValue(&txtRecord, "text1", prvStrLen((const unsigned char *) "text1_content"), "text1_content");
		TXTRecordSetValue(&txtRecord, "text2", prvStrLen((const unsigned char *) "text2_content"), "text2_content");
		dnsServiceRef = mDNSRegisterService("ameba", "_service1._tcp", "local", 5000, &txtRecord);
		TXTRecordDeallocate(&txtRecord);
		rtl_printf("wait for 30s ... \n");
		vTaskDelay(30*1000);
		
		rtl_printf("mDNS Update service\n");
		TXTRecordCreate(&txtRecord, sizeof(txt_buf), txt_buf);
		TXTRecordSetValue(&txtRecord, "text1", prvStrLen((const unsigned char *) "text1_content_new"), "text1_content_new");
...
{
	if(xTaskGenericCreate( ( example_mdns_thread ), ( ((const char*)"example_mdns_thread") ), ( 1024 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
