#line 1 "D:\\vm-share\\506\\driver\\hal_key.c"
...
#line 3 "D:\\vm-share\\506\\driver\\hal_key.c"
...
#line 5 "D:\\vm-share\\506\\driver\\hal_key.c"
...
#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\freertos_v8.1.2\\Source\\include\\task.h"
...
#line 75 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\freertos_v8.1.2\\Source\\include\\task.h"
...
#line 1141 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\freertos_v8.1.2\\Source\\include\\task.h"
...
#line 77 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\os\\freertos\\freertos_v8.1.2\\Source\\include\\timers.h"
...
#line 6 "D:\\vm-share\\506\\driver\\hal_key.c"
...
#line 8 "D:\\vm-share\\506\\driver\\hal_key.c"
...
#line 9 "D:\\vm-share\\506\\driver\\hal_key.c"
...
#line 11 "D:\\vm-share\\506\\driver\\hal_key.c"
...
#line 5 "D:\\vm-share\\506\\driver\\keyboard.h"
...
#line 6 "D:\\vm-share\\506\\driver\\keyboard.h"
...
#line 12 "D:\\vm-share\\506\\driver\\hal_key.c"
#line 1 "D:\\vm-share\\506\\driver\\hal_key.h"
...
#line 13 "D:\\vm-share\\506\\driver\\hal_key.c"
...
void _k5sTimer(TimerHandle_t xTimer, void *callback_arg)
{
    do{if(g_log_level >= 0) {printf("[D]%s"  "press key is 5s !\n",rtos_time_print());}}while(0);
    m_key5s_flag = 1;
}
...
UINT8 _isKeyPress5s(void)
{
    ...
    do{if(g_log_level >= -3) {printf("[E]%s"  "<%s(%d)> " "key press 5s flag %d\n",rtos_time_print(), __FUNCTION__, 34,flag);}}while(0);
    return flag;
}
...
void _k5sTimerStart(void)
{
    ...
    if (m_key5s_timer) {
        xTimerGenericCommand( ( m_key5s_timer ), ( ( BaseType_t ) 7 ), ( xTaskGetTickCountFromISR() ), ( 0 ), 0U );
    }
...
{
    if (m_key5s_timer) {
        xTimerGenericCommand( ( m_key5s_timer ), ( ( BaseType_t ) 8 ), 0, ( 0 ), 0U );
    }
...
void HALKey_Init(DeviceEventCallback cb,struct key_gpio_info key_init_info)
{
    ...
    m_key5s_timer = xTimerCreate(
            "Key5sTimer", (5 * 1000) / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ),
            ( ( BaseType_t ) 0 ), (void *)0, _k5sTimer);
