#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\port\\realtek\\freertos\\sys_arch.c"
...
#line 102 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\include\\lwip/debug.h"
...
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\os\\os_dep\\include\\tcm_heap.h"
...
#line 6 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\os\\os_dep\\include\\tcm_heap.h"
...
#line 7 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\os\\os_dep\\include\\tcm_heap.h"
...
err_t sys_mbox_new(sys_mbox_t *mbox, int size)
{
	...
	*mbox = xQueueGenericCreate( size, sizeof( void * ), ( ( uint8_t ) 0U ) );
...
TickType_t StartTime, EndTime, Elapsed;
	...
	if ( timeout != 0 )
	{
		if ( ( ( BaseType_t ) 1 ) == xQueueGenericReceive( ( *mbox ), ( &(*msg) ), ( timeout / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ) ), ( ( BaseType_t ) 0 ) ) )
		{
			EndTime = xTaskGetTickCount();
			Elapsed = (EndTime - StartTime) * ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) );
	...
	{
		while( ( ( BaseType_t ) 1 ) != xQueueGenericReceive( ( *mbox ), ( &(*msg) ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) ){} 
		EndTime = xTaskGetTickCount();
		Elapsed = (EndTime - StartTime) * ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) );
...
#line 255 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\port\\realtek\\freertos\\sys_arch.c"
...
TickType_t StartTime, EndTime, Elapsed;
	...
	if(	timeout != 0)
	{
		if( xQueueGenericReceive( ( QueueHandle_t ) ( *sem ), 0, ( timeout / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ) ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 ) )
		{
			EndTime = xTaskGetTickCount();
			Elapsed = (EndTime - StartTime) * ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) );
...
#line 436 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\port\\realtek\\freertos\\sys_arch.c"
...
int result;
   ...
   {
	   vPortEnterCritical();
#line 472 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\port\\realtek\\freertos\\sys_arch.c"
...
int sys_thread_delete(TaskHandle_t pid)
{
	int i, isFind = 0;
	struct timeoutlist *tl, *tend = 0;

	pid = (( pid == 0)?(TaskHandle_t) vTaskGetCurrentTCB() : pid);

	if (s_nextthread)
	{
		vPortEnterCritical();

		tend = &(s_timeoutlist[s_nextthread-1]);
		for(i = 0; i < s_nextthread; i++)
		{
			tl = &(s_timeoutlist[i]);
			if(tl->pid == pid)
			{
				_memcpy(tl, tend, sizeof(struct timeoutlist));
				_memset(tend, 0, sizeof(struct timeoutlist));
				s_nextthread --;
				isFind = 1;
				break;
			}
