...
tcpip_thread(void *arg)
{
  ...
  while (1) {                           
    ...
    case TCPIP_MSG_API:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcpip_thread: API message %p\n", (void *)msg); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    case TCPIP_MSG_INPKT:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcpip_thread: PACKET %p\n", (void *)msg); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
#line 121 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\tcpip.c"


    case TCPIP_MSG_TIMEOUT:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcpip_thread: TIMEOUT %p\n", (void *)msg); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      sys_timeout(msg->msg.tmo.msecs, msg->msg.tmo.h, msg->msg.tmo.arg);
      memp_free(MEMP_TCPIP_MSG_API, msg);
      break;
    case TCPIP_MSG_UNTIMEOUT:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcpip_thread: UNTIMEOUT %p\n", (void *)msg); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    case TCPIP_MSG_CALLBACK:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcpip_thread: CALLBACK %p\n", (void *)msg); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      msg->msg.cb.function(msg->msg.cb.ctx);
      memp_free(MEMP_TCPIP_MSG_API, msg);
      break;

    case TCPIP_MSG_CALLBACK_STATIC:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcpip_thread: CALLBACK_STATIC %p\n", (void *)msg); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      msg->msg.cb.function(msg->msg.cb.ctx);
      break;

    default:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("tcpip_thread: invalid message: %d\n", msg->type); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { if(!(0)) ; } while(0);
      break;
    }
  }
...
{
#line 180 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\tcpip.c"
  struct tcpip_msg *msg;
...
tcpip_apimsg(struct api_msg *apimsg)
{
  ...
  if (sys_mbox_valid(&mbox)) {
    UBaseType_t prio = uxTaskPriorityGet(0);       
    if(((( 11 ) - 2) + 1) > prio)
      vTaskPrioritySet(0, (( 11 ) - 2) + 1);  
...
#line 355 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\tcpip.c"

#line 405 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\tcpip.c"
...
tcpip_init(tcpip_init_done_fn initfunc, void *arg)
{
  ...
  if(sys_mbox_new(&mbox, 6) != 0) {
    do { if(!(0)) ; } while(0);
  }
#line 478 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\tcpip.c"
	sys_thread_new("TCP_IP", tcpip_thread, 0, 1000, (( 11 ) - 2));
