#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\us_ticker.c"
...
#line 11 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\us_ticker.c"
#line 1 "D:\\1\\IAR\\arm\\inc\\c\\stddef.h"
...
#line 12 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\us_ticker.c"
...
#line 13 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\us_ticker.c"
...
void us_ticker_init(void) 
{
	...
	RTIM_TimeBaseInit(((RTIM_TypeDef *) (0x40002000 + 0x040)), &TIM_InitStruct, 0, (IRQ_FUN) _us_ticker_irq_handler, (uint32_t)0);
	RTIM_Cmd(((RTIM_TypeDef *) 0x40002000), 1);

	do { if ((LEVEL_INFO < LEVEL_NUMs) && (MODULE_TIMER < MODULE_NUMs) && (ConfigDebug[LEVEL_INFO] & (1<<(MODULE_TIMER)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "%s: Timer_Id=%d\n"; } }while(0);
}
...
uint32_t us_ticker_read() 
{
	...
	tick_cnt = SYSTIMER_TickGet(); 
	us_tick = tick_cnt * (1000000/32768);
	
	return ((uint32_t)us_tick);
}
#line 97 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\us_ticker.c"
...
void us_ticker_set_interrupt(timestamp_t timestamp) 
{
	...
	RTIM_ChangePeriod(TIMx[1], timer_tick);
}
