#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"


#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 54 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 55 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 56 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 57 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 58 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 70 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 170 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 173 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 392 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 471 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 544 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 593 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 648 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 702 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 755 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.h"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
#line 23 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
static void add_thread_signal_map (osThreadId thread_id, EventGroupHandle_t signals)
{
    ...
    prec_entity = (ThreadSignalRec*) pvPortMalloc(sizeof(ThreadSignalRec));

    if (prec_entity != 0) {
        prec_entity->thread_id = thread_id;
        prec_entity->signals = signals;
        prec_entity->pnext = 0;
        if (pThreadSignalMapHead == 0) {
        ...
        do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "\n\r%s: " "No Free Thread-Signal entity\n", __FUNCTION__);}while(0);
    }

#line 116 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
{
    EventGroupHandle_t signals_hdl=0;
...
#line 161 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
    ...
    if (0 == signals_hdl) {
        do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "\n\r%s: " "Cannot find the EventGroup Handle by thread_id\n", __FUNCTION__);}while(0);
    }
...
#line 234 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
static TickType_t millisec_to_ticks(uint32_t millisec)
{
    TickType_t ticks=0;
    ...
    if (millisec == 0xFFFFFFFF) {
        ...
        if (millisec != 0) {
            ticks = millisec/( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) );
            if (ticks == 0) {
                ticks = 1;
            }
        }
...
osThreadId osThreadCreate (const osThreadDef_t *thread_def, void *argument)
{
    ...
    result = xTaskGenericCreate( ( (TaskFunction_t)thread_def->pthread ), ( (const char *)thread_def->name ), ( (thread_def->stacksize/4) ), ( argument ), ( makeFreeRtosPriority(thread_def->tpriority) ), ( &handle ), ( 0 ), ( 0 ) );
    ...
    if (( ( ( BaseType_t ) 1 ) ) == result) {
        ...
        if (signals == 0) {
            ...
            do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "\n\r%s: " "Create a EventGroup for a new thread failed\n", __FUNCTION__);}while(0);
        }
        else
        {
    ...
    {
        do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "\n\r%s: " "Create a new thread(%s) failed\r\n", __FUNCTION__,thread_def->name);}while(0);
    }
...
osStatus osDelay (uint32_t millisec)
{
    ...
    TickType_t ticks = (millisec * ( ( uint32_t ) 1000 )) / 1000;
...
static void _osTimerCallbackFreeRTOS (TimerHandle_t handle)
{
...
osStatus osTimerStart (osTimerId timer_id, uint32_t millisec)
{
    ...
    TickType_t ticks = millisec / ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) );
    if (ticks == 0) {
        ticks = 1;
    }
    ...
    if (inHandlerMode()) {
        if (xTimerGenericCommand( ( timer_id ), ( ( BaseType_t ) 9 ), ( ticks ), ( &taskWoken ), 0U ) == ( ( ( BaseType_t ) 1 ) )) {
            xTimerGenericCommand( ( timer_id ), ( ( BaseType_t ) 6 ), ( xTaskGetTickCountFromISR() ), ( &taskWoken ), 0U );
        ...
        if (xTimerGenericCommand( ( timer_id ), ( ( BaseType_t ) 4 ), ( ticks ), 0, ( 0 ) ) != ( ( ( BaseType_t ) 1 ) )) {
            ...
            if (xTimerGenericCommand( ( timer_id ), ( ( BaseType_t ) 1 ), ( xTaskGetTickCount() ), 0, ( 0 ) ) != ( ( ( BaseType_t ) 1 ) )) {
                result = osErrorOS;
            }
        }
    }
...
osStatus osTimerStop (osTimerId timer_id)
{
    ...
    if (inHandlerMode()) {
        xTimerGenericCommand( ( timer_id ), ( ( BaseType_t ) 8 ), 0, ( &taskWoken ), 0U );
        if( taskWoken ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );
    }
    else {
...
osStatus osTimerDelete (osTimerId timer_id)
{
    ...
    if (xTimerGenericCommand( ( timer_id ), ( ( BaseType_t ) 5 ), 0U, 0, ( ( TickType_t ) 0xffffffffUL ) ) != ( ( ( BaseType_t ) 1 ) )) {
        result = osErrorOS;
    }
...
int32_t osSignalSet (osThreadId thread_id, int32_t signals)
{
    ...
    if (event_handle) {
        if (inHandlerMode()) {
            ...
            xResult = xTimerPendFunctionCallFromISR( vEventGroupSetBitsCallback, ( void * ) event_handle, ( uint32_t ) signals, &taskWoken );
            ...
            uxBits_ret = xEventGroupClearBits( event_handle, 0 );
    ...
    if (event_handle) {
        if (inHandlerMode()) {
            uxBits_ret = xEventGroupGetBitsFromISR(event_handle);
                      ...
                      xTimerPendFunctionCallFromISR( vEventGroupClearBitsCallback, ( void * ) event_handle, ( uint32_t ) signals, 0 ); 
...
#line 710 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
osStatus osMutexWait (osMutexId mutex_id, uint32_t millisec)
{
    ...
    if (xQueueGenericReceive( ( QueueHandle_t ) ( mutex_id ), 0, ( ticks ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
        return osErrorOS;
    }
...
osStatus osMutexRelease (osMutexId mutex_id)
{
    ...
    if (inHandlerMode()) {
        if (xQueueGenericSendFromISR( ( QueueHandle_t ) ( mutex_id ), 0, ( &taskWoken ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            result = osErrorOS;
        }
        if( taskWoken ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );
    }
    else {
        if (xQueueGenericSend( ( QueueHandle_t ) ( mutex_id ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            result = osErrorOS;
        }
    }
...
osStatus osMutexDelete (osMutexId mutex_id)
{
	...
	vQueueDelete( ( QueueHandle_t ) ( mutex_id ) );
    return osOK;
}
...
int32_t osSemaphoreWait (osSemaphoreId semaphore_id, uint32_t millisec)
{
    ...
    if (xQueueGenericReceive( ( QueueHandle_t ) ( semaphore_id ), 0, ( ticks ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
        return osErrorOS;
    }
...
osStatus osSemaphoreRelease (osSemaphoreId semaphore_id)
{
    ...
    if (inHandlerMode()) {
        if (xQueueGenericSendFromISR( ( QueueHandle_t ) ( semaphore_id ), 0, ( &taskWoken ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            result = osErrorOS;
        }
        if( taskWoken ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );
    }
...
#line 911 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
#line 933 "D:\\vm-share\\506\\rtk8710_sdk\\component\\os\\freertos\\cmsis_os.c"
...
osStatus osMessagePut (osMessageQId queue_id, uint32_t info, uint32_t millisec)
{
    ...
    if (inHandlerMode()) {
        if (xQueueGenericSendFromISR( ( queue_id ), ( (const void *)info ), ( &taskWoken ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            return osErrorOS;
        }
        if( taskWoken ) ( * ( ( volatile uint32_t * ) 0xe000ed04 ) ) = ( 1UL << 28UL );        
    }
        ...
        if (xQueueGenericSend( ( queue_id ), ( (const void *)info ), ( ticks ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            return osErrorOS;
        }
    }
...
osEvent osMessageGet (osMessageQId queue_id, uint32_t millisec)
{
    ...
    if (inHandlerMode()) {
        if (xQueueReceiveFromISR(queue_id, (void *)retEvent.value.p, &taskWoken) != ( ( BaseType_t ) 1 )) {
        ...
        if (xQueueGenericReceive( ( queue_id ), ( (void *)retEvent . value . p ), ( ticks ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {
            retEvent.status = osErrorOS;
            return retEvent;
        }
    }
...
void *osMailCAlloc (osMailQId queue_id, uint32_t millisec)
{
    ...
    if (p) {
        _memset(p, 0, queue_id->queue_def->item_sz);
    }
...
{
    long taskWoken;
    TickType_t ticks=1000/( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) );   
    ...
    if (inHandlerMode()) {
        ...
        if (xQueueGenericSend( ( queue_id->handle ), ( &mail ), ( ticks ), ( ( BaseType_t ) 0 ) ) != ( ( BaseType_t ) 1 )) {  
            return osErrorOS;
        }
    }
