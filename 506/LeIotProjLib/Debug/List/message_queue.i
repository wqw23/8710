#line 1 "D:\\vm-share\\506\\product\\message_queue.c"
...
#line 10 "D:\\vm-share\\506\\product\\message_queue.c"
...
#line 11 "D:\\vm-share\\506\\product\\message_queue.c"
...
#line 13 "D:\\vm-share\\506\\product\\message_queue.c"
...
#line 14 "D:\\vm-share\\506\\product\\message_queue.c"
...
#line 15 "D:\\vm-share\\506\\product\\message_queue.c"
...
#line 12 "D:\\vm-share\\506\\product\\message_queue.h"
...
#line 13 "D:\\vm-share\\506\\product\\message_queue.h"
...
#line 14 "D:\\vm-share\\506\\product\\message_queue.h"
...
#line 20 "D:\\vm-share\\506\\product\\message_queue.c"
...
UINT8 Message_Queue_Semaphore_Start( QueueHandle_t xQueue,TickType_t xTicksToWait)
{
    xQueueGenericReceive( ( QueueHandle_t ) ( xQueue ), 0, ( xTicksToWait ), ( ( BaseType_t ) 0 ) );
    return (1);
}
...
UINT8 Message_Queue_Semaphore_Stop( QueueHandle_t xQueue)
{
    xQueueGenericSend( ( QueueHandle_t ) ( xQueue ), 0, ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return (1);
}
...
UINT8 Message_Queue_QueueReceive(QueueHandle_t xQueue,void *pvBuffer,TickType_t xTicksToWait)
{
    ...
    if(( ( BaseType_t ) 1 )==xQueueGenericReceive( ( xQueue ), ( (void * )pvBuffer ), ( xTicksToWait ), ( ( BaseType_t ) 0 ) ))
        return (1);
    else
        return (0);
}
...
UINT8 Message_Queue_QueueSend(QueueHandle_t xQueue,const void * pvItemToQueue,TickType_t xTicksToWait)
{
    if(( ( BaseType_t ) 1 )==xQueueGenericSend( ( xQueue ), ( pvItemToQueue ), ( xTicksToWait ), ( ( BaseType_t ) 0 ) ))
        return (1);
     else
        return (0);
}
...
void* Message_Queue_Create_xSemaphoreCreateMutex(void)
{
    SemaphoreHandle_t send_data_mutex;

    send_data_mutex = xQueueCreateMutex( ( ( uint8_t ) 1U ) );
    if(0 == send_data_mutex)
    {
        return (0);
    }
...
void Message_Queue_Receive_Handle_Task(void *arg)
{
    ...
    while(1)
    {
         if(( ( BaseType_t ) 1 )==Message_Queue_QueueReceive(Message_Queue_Info->message_queue_handle_t,(void * )receive_quent_data,0)){
            ...
            vTaskDelay(50/( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ));
        }
    }
}
...
UINT8 Message_StartLoop(Message_Queue_Info_t* Message_Queue_Info)
{
    do{if(g_log_level >= 0) {printf("[D]%s"  "<%s:%d>:" "queue_name=%s--Message_Loop\n",rtos_time_print(),__FUNCTION__, 179,Message_Queue_Info->queue_name);}}while(0);

    if(( ( ( BaseType_t ) 1 ) ) != xTaskGenericCreate( ( Message_Queue_Receive_Handle_Task ), ( Message_Queue_Info->queue_name ), ( 512 ), ( (void*)Message_Queue_Info ), ( 4 ), ( &Message_Queue_Info->xqueueTask ), ( 0 ), ( 0 ) ))
    {
        return (0);
    }
    return (1);
...
void* Message_Queue_Create(queue_recv_callback cb,UINT8* queue_name,UBaseType_t uxQueueLength,UBaseType_t uxItemSize)
{
    do{if(g_log_level >= 0) {printf("[D]%s"  "<%s:%d>:" "Message_Queue_Init\n",rtos_time_print(),__FUNCTION__, 213);}}while(0);
    Message_Queue_Info_t* Message_Queue_Info;

    Message_Queue_Info=(Message_Queue_Info_t*)pvPortMalloc(sizeof(Message_Queue_Info_t));
    if(0 == Message_Queue_Info)
    {
        do{if(g_log_level >= 0) {printf("[D]%s"  "Message_Queue_Info_t malloc error.\n",rtos_time_print());}}while(0);
    }
    Message_Queue_Info->queue_name=queue_name;
    Message_Queue_Info->message_queue_handle_t = xQueueGenericCreate( uxQueueLength, uxItemSize, ( ( uint8_t ) 0U ) );
    do{if(g_log_level >= 0) {printf("[D]%s"  "<%s:%d>:" "%s-Message_Queue_Info->message_queue_handle_t=%d\n",rtos_time_print(),__FUNCTION__, 223,Message_Queue_Info->queue_name,Message_Queue_Info->message_queue_handle_t);}}while(0);
    if(0 == Message_Queue_Info->message_queue_handle_t)
    {
        do{if(g_log_level >= 0) {printf("[D]%s"  "<%s:%d>:" "Queue was not created and must not be used.\n",rtos_time_print(),__FUNCTION__, 226);}}while(0);
        return (0);
    }
