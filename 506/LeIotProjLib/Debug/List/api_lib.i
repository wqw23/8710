...
netconn_new_with_proto_and_callback(enum netconn_type t, u8_t proto, netconn_callback callback)
{
  ...
  if (conn != 0) {
    ...
    msg.msg.conn = conn;
    if (tcpip_apimsg(&msg) != 0) {
      do { if(!(conn->pcb . tcp == 0)) ; } while(0);
      do { if(!(sys_sem_valid(&conn->op_completed))) ; } while(0);
      do { if(!(sys_mbox_valid(&conn->recvmbox))) ; } while(0);

      do { if(!(!sys_mbox_valid(&conn->acceptmbox))) ; } while(0);
...
netconn_getaddr(struct netconn *conn, ip_addr_t *addr, u16_t *port, u8_t local)
{
  ...
  do { if (!((conn != 0))) { ; return -14;;}} while(0);
  do { if (!((addr != 0))) { ; return -14;;}} while(0);
  do { if (!((port != 0))) { ; return -14;;}} while(0);
...
netconn_accept(struct netconn *conn, struct netconn **new_conn)
{
  ...
  do { if (!((new_conn != 0))) { ; return -14;;}} while(0);
  *new_conn = 0;
  do { if (!((conn != 0))) { ; return -14;;}} while(0);
  do { if (!(sys_mbox_valid(&conn->acceptmbox))) { ; return -14;;}} while(0);
  ...
  if (sys_arch_mbox_fetch(&conn->acceptmbox, (void **)&newconn, conn->recv_timeout) == 0xffffffffUL) {
    do { sys_prot_t lev; lev = sys_arch_protect(); if (!(((conn)->last_err) < -9)) { (conn)->last_err = -3; } sys_arch_unprotect(lev); } while(0);;
    return -3;
  }
  ...
  if (newconn == 0) {
    ...
    do { sys_prot_t lev; lev = sys_arch_protect(); if (!(((conn)->last_err) < -9)) { (conn)->last_err = -10; } sys_arch_unprotect(lev); } while(0);;
    return -10;
  }
#line 321 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_lib.c"
...
netconn_recv_data(struct netconn *conn, void **new_buf)
{
  ...
  do { if (!((new_buf != 0))) { ; return -14;;}} while(0);
  *new_buf = 0;
  do { if (!((conn != 0))) { ; return -14;;}} while(0);
  do { if (!(sys_mbox_valid(&conn->recvmbox))) { ; return -13;;}} while(0);
...

  {
    ...
    if (buf == 0) {
      ...
      do { sys_prot_t lev; lev = sys_arch_protect(); if (!(((conn)->last_err) < -9)) { (conn)->last_err = -12; } sys_arch_unprotect(lev); } while(0);;
      return -12;
    }
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("netconn_recv_data: received %p, len=%" "d" "\n", buf, len); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
{
  do { if (!((conn != 0) && (conn->type) == NETCONN_TCP)) { ; return -14;;}} while(0);
...
netconn_recv(struct netconn *conn, struct netbuf **new_buf)
{
  ...
  *new_buf = 0;
...

  {
    ...
    if (buf == 0) {
      do { sys_prot_t lev; lev = sys_arch_protect(); if (!(((conn)->last_err) < -9)) { (conn)->last_err = -1; } sys_arch_unprotect(lev); } while(0);;
      return -1;
    }
...
netconn_recved(struct netconn *conn, u32_t length)
{
  ...
  if ((conn != 0) && (conn->type == NETCONN_TCP) &&
      ((((conn)->flags & 0x08) != 0))) {
    struct api_msg msg;
...
netconn_send(struct netconn *conn, struct netbuf *buf)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { rtl_printf ("netconn_send: sending %" "d" " bytes\n", buf->p->tot_len); if ((0x00U) & 0x08U) { while(1); } } } while(0);
                     ...
                     u8_t apiflags, size_t *bytes_written)
{
  ...
  do { if (!((conn != 0))) { ; return -14;;}} while(0);
  do { if (!((conn->type == NETCONN_TCP))) { ; return -6;;}} while(0);
  if (size == 0) {
    return 0;
  }
...
#line 632 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\api\\api_lib.c"
...
netconn_gethostbyname(const char *name, ip_addr_t *addr)
{
  ...
  do { if (!((name != 0))) { ; return -14;;}} while(0);
  do { if (!((addr != 0))) { ; return -14;;}} while(0);
...
err_t netconn_abort(struct netconn *conn)
{
  if (conn->acceptmbox != (QueueHandle_t)0) {
     
    if (conn->callback) { (*conn->callback)(conn, NETCONN_EVT_RCVPLUS, 0); };
    sys_mbox_post(&conn->acceptmbox, 0);
  }
  return 0;
}
