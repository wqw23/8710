#line 1 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 7 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 8 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 9 "D:\\vm-share\\506\\driver\\keyboard.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal_ext\\gpio_irq_ex_api.h"
...
#line 11 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 12 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 13 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 14 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 16 "D:\\vm-share\\506\\driver\\keyboard.c"

#line 1 "D:\\vm-share\\506\\driver\\keyboard.h"
...
#line 7 "D:\\vm-share\\506\\driver\\keyboard.h"
...
#line 18 "D:\\vm-share\\506\\driver\\keyboard.c"
...
#line 19 "D:\\vm-share\\506\\driver\\keyboard.c"
...
void gpio_key_irq_handler()
{
    if(key_irq_flag && gpio_read(&g_key_gpio_info.gpio_key))
    {
        ...
        key_action_callback(KEY_UP);

        
        gpio_irq_set(&g_key_gpio_info.gpio_key,KEY_DOWN , 1);
        key_irq_flag = 0;
    }
    ...
    xTimerGenericCommand( ( key_ignore_shake_timer ), ( ( BaseType_t ) 5 ), 0U, 0, ( ( TickType_t ) 0xffffffffUL ) );
}
...
void key_irq_function(uint32_t id, gpio_irq_event event)
{
    ...
    key_ignore_shake_timer = xTimerCreate( "KeyIgnoreShakeTimer",( 10/ ( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) )),( ( BaseType_t ) 0 ),0,gpio_key_irq_handler);
    if(key_ignore_shake_timer == 0){
        do{if(g_log_level >= 0) {printf("[D]%s" "KEY" ": " "The KeyIgnoreShakeTimer timer was not created.\n",rtos_time_print());}}while(0);
    }else{
        if(xTimerGenericCommand( ( key_ignore_shake_timer ), ( ( BaseType_t ) 1 ), ( xTaskGetTickCount() ), 0, ( 0 ) ) != ( ( ( BaseType_t ) 1 ) )){
            do{if(g_log_level >= 0) {printf("[D]%s" "KEY" ": " "The KeyIgnoreShakeTimer timer could not be set into the Active state.\n",rtos_time_print());}}while(0);
        }
    }
}
...
void key_init(key_event_callback cb,struct key_gpio_info key_init_info)
{
    do{if(g_log_level >= 0) {printf("[D]%s" "KEY" ": " "%s==>\n",rtos_time_print(),__FUNCTION__);}}while(0);
    key_action_callback = cb;
    g_key_gpio_info = key_init_info;

    
    gpio_irq_init(&g_key_gpio_info.gpio_key, g_key_gpio_info.switch_pin_num, key_irq_function, 0);
    gpio_irq_set(&g_key_gpio_info.gpio_key, KEY_DOWN, 1);   
    gpio_irq_enable(&g_key_gpio_info.gpio_key);
