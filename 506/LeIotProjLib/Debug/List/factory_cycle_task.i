#line 1 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 5 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 7 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 8 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 9 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 10 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 12 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 13 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 7 "D:\\vm-share\\506\\LeIotProjLib\\..\\driver\\led.h"
...
#line 14 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
#line 15 "D:\\vm-share\\506\\adapter\\factory_cycle_task.c"
...
void factory_cycle_auto_task(void *arg)  
{
    do{if(g_log_level >= 0) {printf("[D]%s"  "factory_cycle_auto_task....\n",rtos_time_print());}}while(0);
    pcba_factory_key_flag=1;
    while(factory_mode)
    {
        if(pcba_factory_key_status)
        {
            do{if(g_log_level >= 0) {printf("[D]%s"  " factory mode test case for JDQ on/off three times \n",rtos_time_print());}}while(0);
            relay_trigger(1);
            vTaskDelay(500/( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ));
            relay_trigger(0);
            vTaskDelay(500/( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ));
            relay_trigger(1);
            vTaskDelay(500/( ( TickType_t ) 1000 / ( ( uint32_t ) 1000 ) ));
            ...
            relay_trigger(0);
            factory_mode = 0;
            do{if(g_log_level >= 0) {printf("[D]%s"  "Exit factory mode !!!\n",rtos_time_print());}}while(0);
            led_wifi_trigger(0);
            led_power_trigger(0);
            vTaskDelete(0);

        }else{
            do{if(g_log_level >= 0) {printf("[D]%s"  "PCBA Factory test case runing ....\n",rtos_time_print());}}while(0);
            led_wifi_trigger(0);
            led_power_trigger(1);
