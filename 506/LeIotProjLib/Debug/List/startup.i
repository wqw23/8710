#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\fwlib\\ram_lib\\startup.c"
...
#line 11 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\fwlib\\ram_lib\\startup.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\adapter\\inc\\build_info.h"
#line 12 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\fwlib\\ram_lib\\startup.c"
...
#line 13 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\fwlib\\ram_lib\\startup.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\cmsis\\device\\system_8195a.h"
...
#line 14 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\fwlib\\ram_lib\\startup.c"

uint32_t random_seed = 0x0;
...
{
	__bss_start__               = (uint8_t*)__section_begin(".ram_image2.bss");
	__bss_end__                 = (uint8_t*)__section_end(".ram_image2.skb.bss");	
}
...
void
HalHardFaultHandler_user_define(uint32_t HardDefaultArg)
{
}

void
HalHardFaultHandler_Patch_c(uint32_t HardDefaultArg)
{
...
void BOOT_VectorTableOverride(uint32_t StackP)
{
...
{
	uint32_t backup_reg0 = BKUP_Read(((uint32_t)0x00000000));

	do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "boot reason: %x \n", backup_reg0);}while(0);
}
...
#line 107 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\fwlib\\ram_lib\\startup.c"
...
void BOOT_RTC_Init(void)
{
	...
	RTC_AlarmStruct_temp.RTC_AlarmMask = ((uint32_t)0x00800000) | ((uint32_t)0x00008000);
	RTC_AlarmStruct_temp.RTC_Alarm2Mask = ((uint32_t)0x00000200);
...
void BOOT_PlatformInit(void)
{
	...
	Temp = ((uint32_t)(*((volatile uint32_t*)(0x40000000 + 0x0064))));
	Temp &= ~((((3) & 0x00000003) << 3));
	Temp |= (((1) & 0x00000003) << 3);
	((*((volatile uint32_t*)(0x40000000 + 0x0064))) = ((uint32_t)(Temp)));
}
...
{
	int ret = 0;
	uint32_t OSC8MCali = 1;

#line 183 "D:\\vm-share\\506\\rtk8710_sdk\\component\\soc\\realtek\\8711b\\fwlib\\ram_lib\\startup.c"
	...
	do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "===== Enter Image 2 ====\n");}while(0);
	...
	OSC8MCali = OSC8M_Calibration(0, 4, 0);
	DelayUs(90);
	DelayUs(90);
	...
	if (SYSCFG0_BDOption() != ((uint32_t)0x000000001)) {
...
_Pragma( "location=\".image2.validate.rodata\"")
const uint8_t RAM_IMG2_VALID_PATTEN[20] = {
	'R', 'T', 'K', 'W', 'i', 'n', 0x0, 0xff, 
	((0x0100)&0xff), (((0x0100) >> 8)&0xff),
	((0x0001)&0xff), (((0x0001) >> 8)&0xff),
	((0x8195)&0xff), (((0x8195) >> 8)&0xff),
	((0x01)),
	((0x01)),
	((0x00)),
	((0x00)),
...
_Pragma( "location=\".image2.entry.data\"")
