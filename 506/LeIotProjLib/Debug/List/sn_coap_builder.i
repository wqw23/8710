...
#line 36 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\coap\\sn_coap_builder.c"
...
sn_coap_hdr_s *sn_coap_build_response(struct coap_s *handle, sn_coap_hdr_s *coap_packet_ptr, uint8_t msg_code)
{
    ...
    if (coap_packet_ptr->token_ptr) {
        ...
        _memcpy(coap_res_ptr->token_ptr, coap_packet_ptr->token_ptr, coap_res_ptr->token_len);
    }
    return coap_res_ptr;
}
...
{
    return sn_coap_builder_2(dst_packet_data_ptr, src_coap_msg_ptr, 0);
}

int16_t sn_coap_builder_2(uint8_t *dst_packet_data_ptr, sn_coap_hdr_s *src_coap_msg_ptr, uint16_t blockwise_payload_size)
{
    do { if(0){ rtl_printf("sn_coap_builder_2" "\n"); if(0){ rtl_printf("Function: %s  ::  Line: %d\n\n",__FUNCTION__,101); } } } while (0);
    uint8_t *base_packet_data_ptr = 0;

     
    if (dst_packet_data_ptr == 0 || src_coap_msg_ptr == 0) {
        return -2;
    }
    ...
    do { if(0){ rtl_printf("sn_coap_builder_2 - message len: [%d]" "\n",dst_byte_count_to_be_built); if(0){ rtl_printf("Function: %s  ::  Line: %d\n\n",__FUNCTION__,111); } } } while (0);
    if (!dst_byte_count_to_be_built) {
        return -1;
    }

    _memset(dst_packet_data_ptr, 0, dst_byte_count_to_be_built);
...
{
    return sn_coap_builder_calc_needed_packet_data_size_2(src_coap_msg_ptr, 0);
}
...
uint16_t sn_coap_builder_calc_needed_packet_data_size_2(sn_coap_hdr_s *src_coap_msg_ptr, uint16_t blockwise_payload_size)
{
    ...
    do { if(0){ rtl_printf("sn_coap_builder_calc_needed_packet_data_size_2" "\n"); if(0){ rtl_printf("Function: %s  ::  Line: %d\n\n",__FUNCTION__,152); } } } while (0);
    ...
    if (src_coap_msg_ptr->msg_type != COAP_MSG_TYPE_RESET) {
        ...
        if (src_coap_msg_ptr->token_ptr != 0) {
            if (src_coap_msg_ptr->token_len > 8 || src_coap_msg_ptr->token_len < 1) {  
                return 0;
            }
        ...
        if (src_coap_msg_ptr->content_format != COAP_CT_NONE) {
            ...
            returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->content_format, COAP_OPTION_CONTENT_FORMAT, &tempInt);
        }
         
        if (src_coap_msg_ptr->options_list_ptr != 0) {
            ...
            if (src_coap_msg_ptr->options_list_ptr->accept != COAP_CT_NONE) {
                ...
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->accept, COAP_OPTION_ACCEPT, &tempInt);
            }
             
            if (src_coap_msg_ptr->options_list_ptr->max_age != 60) {
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->max_age, COAP_OPTION_MAX_AGE, &tempInt);
            }
             
            if (src_coap_msg_ptr->options_list_ptr->proxy_uri_ptr != 0) {
                if (src_coap_msg_ptr->options_list_ptr->proxy_uri_len >= 1 && src_coap_msg_ptr->options_list_ptr->proxy_uri_len <= 12) {             
                    returned_byte_count++;
                }
            ...
            if (src_coap_msg_ptr->options_list_ptr->etag_ptr != 0) {
            ...
            if (src_coap_msg_ptr->options_list_ptr->uri_host_ptr != 0) {
            ...
            if (src_coap_msg_ptr->options_list_ptr->location_path_ptr != 0) {
            ...
            if (src_coap_msg_ptr->options_list_ptr->uri_port != (-1)) {
                if ((uint32_t) src_coap_msg_ptr->options_list_ptr->uri_port > 0xffff) {
                    return 0;
                }
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->uri_port, COAP_OPTION_URI_PORT, &tempInt);
            }
             
            if (src_coap_msg_ptr->options_list_ptr->location_query_ptr != 0) {
            ...
            if (src_coap_msg_ptr->options_list_ptr->observe != COAP_OBSERVE_NONE) {
                ...
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->observe, COAP_OPTION_OBSERVE, &tempInt);
            }
             
            if (src_coap_msg_ptr->options_list_ptr->uri_query_ptr != 0) {
            ...
            if (src_coap_msg_ptr->options_list_ptr->block1 != (-1)) {
                if ((uint32_t) src_coap_msg_ptr->options_list_ptr->block1 > 0xffffff) {
                    return 0;
                }
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->block1, COAP_OPTION_BLOCK1, &tempInt);
            }
             
            if (src_coap_msg_ptr->options_list_ptr->use_size1) {
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->size1, COAP_OPTION_SIZE1, &tempInt);
            }
             
            if (src_coap_msg_ptr->options_list_ptr->block2 != (-1)) {
                if ((uint32_t) src_coap_msg_ptr->options_list_ptr->block2 > 0xffffff) {
                    return 0;
                }
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->block2, COAP_OPTION_BLOCK2, &tempInt);
            }
             
            if (src_coap_msg_ptr->options_list_ptr->use_size2) {
                returned_byte_count += sn_coap_builder_options_build_add_uint_option(0, src_coap_msg_ptr->options_list_ptr->size2, COAP_OPTION_SIZE2, &tempInt);
            }
        }
#line 332 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\coap\\sn_coap_builder.c"
...
static uint8_t sn_coap_builder_options_calculate_jump_need(sn_coap_hdr_s *src_coap_msg_ptr )
{
    ...
    if (src_coap_msg_ptr->options_list_ptr != 0) {
        ...
        if (!src_coap_msg_ptr->options_list_ptr->uri_query_ptr       &&
                ...
                src_coap_msg_ptr->options_list_ptr->block2 == (-1) &&
                src_coap_msg_ptr->options_list_ptr->block1 == (-1) &&
                !src_coap_msg_ptr->options_list_ptr->proxy_uri_ptr      &&
                src_coap_msg_ptr->options_list_ptr->max_age == 60 &&
...
static int8_t sn_coap_builder_header_build(uint8_t **dst_packet_data_pptr, sn_coap_hdr_s *src_coap_msg_ptr)
{
    ...
    if (sn_coap_header_validity_check(src_coap_msg_ptr, COAP_VERSION_1) != 0) {
        return -1;
    }

     
    **dst_packet_data_pptr += COAP_VERSION_1;
    ...
    **dst_packet_data_pptr = (uint8_t)(src_coap_msg_ptr->msg_id >> 8);  
    (*dst_packet_data_pptr) ++;
    **dst_packet_data_pptr = (uint8_t)src_coap_msg_ptr->msg_id;                                    
    (*dst_packet_data_pptr) ++;
...
static int8_t sn_coap_builder_options_build(uint8_t **dst_packet_data_pptr, sn_coap_hdr_s *src_coap_msg_ptr)
{
    ...
    if (src_coap_msg_ptr->uri_path_ptr == 0 && src_coap_msg_ptr->token_ptr == 0 &&
            src_coap_msg_ptr->content_format == COAP_CT_NONE && src_coap_msg_ptr->options_list_ptr == 0) {
        return 0;
    }

     
    if (src_coap_msg_ptr->token_len && src_coap_msg_ptr->token_ptr) {
        _memcpy(*dst_packet_data_pptr, src_coap_msg_ptr->token_ptr, src_coap_msg_ptr->token_len);
    }
    (*dst_packet_data_pptr) += src_coap_msg_ptr->token_len;
        ...
        uint8_t *option_ptr, sn_coap_option_numbers_e option_number, uint16_t *previous_option_number)
{
    ...
    if (option_ptr != 0) {
        ...
        *previous_option_number = option_number;
        ...
        _memcpy(*dst_packet_data_pptr, option_ptr, option_len);
...
static uint8_t sn_coap_builder_options_get_option_part_count(uint16_t query_len, uint8_t *query_ptr, sn_coap_option_numbers_e option)
{
    ...
    for (query_len_index = 1; query_len_index < query_len - 1; query_len_index++) {
        ...
        if (*(query_ptr + query_len_index) == char_to_search) {  
        ...
        uint8_t query_index, sn_coap_option_numbers_e option)
{
    ...
    for (query_len_index = 0; query_len_index < query_len; query_len_index++) {
        ...
        if (temp_char == char_to_search && returned_query_part_len > 0) {  
            ...
            temp_query_index++;
        } else if (temp_char != char_to_search) {  
        ...
        uint8_t query_index, sn_coap_option_numbers_e option)
{
    ...
    for (query_len_index = 0; query_len_index < query_len; query_len_index++) {
        ...
        if (temp_char == char_to_search && returned_query_part_offset > 0) {  
             
            if (temp_query_index == (query_index - 1)) {
                 
                return (returned_query_part_offset + 1);  
            }
...
static void sn_coap_builder_payload_build(uint8_t **dst_packet_data_pptr, sn_coap_hdr_s *src_coap_msg_ptr)
{
    ...
    if (src_coap_msg_ptr->payload_len && src_coap_msg_ptr->payload_ptr != 0) {
        ...
        **dst_packet_data_pptr = 0xff;
        ...
        _memcpy(*dst_packet_data_pptr, src_coap_msg_ptr->payload_ptr, src_coap_msg_ptr->payload_len);
