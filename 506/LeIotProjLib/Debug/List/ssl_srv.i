...
#line 148 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 176 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"

 


#line 195 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"


 
#line 204 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 291 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 304 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 384 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 449 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
};
...
struct _ssl_handshake_params
{
    ...
    int cert_type;                       
    int verify_sig_alg;                  
#line 603 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 840 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 856 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 885 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 1240 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"

#line 1266 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"

#line 1288 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
...
#line 1350 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl\\ssl.h"
                             ...
                             size_t *olen )
{
    ...
    _memcpy(p, session, sizeof( ssl_session ));
    ...
    *p++ = (unsigned char)( cert_len       & 0xFF );
    ...
    if( session->peer_cert != 0 )
        _memcpy(p, session->peer_cert->raw . p, cert_len);
                             ...
                             const unsigned char *buf, size_t len )
{
    ...
    _memcpy(session, p, sizeof( ssl_session ));
    p += sizeof( ssl_session );
    ...
    else
    {
        ...
        session->peer_cert = rom_ssl_ram_map . ssl_malloc( sizeof( x509_crt ) );
...
static int ssl_write_ticket( ssl_context *ssl, size_t *tlen )
{
    ...
    *tlen = 0;
    ...
    _memcpy(p, ssl->ticket_keys->key_name, 16);
    p += 16;
    ...
    if(rom_ssl_ram_map.use_hw_crypto_func)
    {
        ...
        if( ( ret = aes_crypt_cbc( &ssl->ticket_keys->enc, 1,
                             ...
                             size_t len )
{
    ...
    {
        device_mutex_lock(RT_DEV_LOCK_CRYPTO);
        if( ( ret = aes_crypt_cbc( &ssl->ticket_keys->dec, 0,
...
#line 365 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
    ...
    _memcpy(&session . id, ssl->session_negotiate ->id, session . length);

    ssl_session_free( ssl->session_negotiate );
    _memcpy(ssl->session_negotiate, &session, sizeof( ssl_session ));
...
#line 618 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 762 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 788 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
                          ...
                          const ssl_ciphersuite_t * ciphersuite_info )
{
    ...
    if( ssl->handshake->sni_key_cert != 0 )
...
#line 836 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
            break;
    }
...
#line 873 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"

#line 883 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 1129 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
static int ssl_parse_client_hello( ssl_context *ssl )
{
    ...
    _memcpy(ssl->handshake ->randbytes, buf + 6, 32);
    ...
    _memset(ssl->session_negotiate ->id, 0, sizeof( ssl->session_negotiate ->id ));

    _memcpy(ssl->session_negotiate ->id, buf + 39, ssl->session_negotiate ->length);
...
#line 1353 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 1452 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 1492 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
    ...
    if( ssl->secure_renegotiation == 0 &&
        ssl->allow_legacy_renegotiation == 2 )
    {
        do { } while( 0 );
        handshake_failure = 1;
    }
    else if( ssl->renegotiation == 1 &&
             ssl->secure_renegotiation == 1 &&
             renegotiation_info_seen == 0 )
    {
        ...
        handshake_failure = 1;
             ...
             ssl->allow_legacy_renegotiation == 0 )
    {
        do { } while( 0 );
        handshake_failure = 1;
    }
                                         ...
                                         size_t *olen )
{
    ...
    *p++ = ssl->verify_data_len * 2 & 0xFF;
    ...
    _memcpy(p, ssl->peer_verify_data, ssl->verify_data_len);
    p += ssl->verify_data_len;
    _memcpy(p, ssl->own_verify_data, ssl->verify_data_len);
    p += ssl->verify_data_len;
...
#line 1732 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"

#line 1768 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 1811 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
    ...
    _memcpy(ssl->handshake ->randbytes + 32, buf + 6, 32);
    ...
    if( ssl->handshake->resume == 0 )
    {
        ...
        if( ssl->handshake->new_session_ticket != 0 )
        {
            ...
            _memset(ssl->session_negotiate ->id, 0, 32);
        }
        else
    ...
    *p++ = (unsigned char) ssl->session_negotiate->length;
    _memcpy(p, ssl->session_negotiate ->id, ssl->session_negotiate ->length);
...
#line 1984 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
static int ssl_write_certificate_request( ssl_context *ssl )
{
    ...
    while( crt != 0 && crt->version != 0 )
    {
        ...
        *p++ = (unsigned char)( dn_size      );
        _memcpy(p, crt->subject_raw . p, dn_size);
        p += dn_size;
...
#line 2154 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 2173 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 2201 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"

#line 2215 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"

#line 2258 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"

#line 2319 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"

#line 2486 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 2567 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 2703 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
...
#line 2916 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
    if( ciphersuite_info->key_exchange == POLARSSL_KEY_EXCHANGE_RSA )
    {
...
#line 2971 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_srv.c"
