#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\http_client\\example_http_client.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\http_client\\example_http_client.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\http_client\\example_http_client.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\http_client\\example_http_client.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\http_client\\example_http_client.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\utilities\\http_client.h"
...
#line 6 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\http_client\\example_http_client.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\example\\http_client/example_http_client.h"
...
#line 7 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\http_client\\example_http_client.c"
...
void http_client(void)
{
    ...
    if(sockfd < 0)
        rtl_printf("[ERROR] Create socket failed\n");
    ...
    serv_addr.sin_port = lwip_htons(port);
    _memcpy(&serv_addr . sin_addr . s_addr, server->h_addr_list[0], server->h_length);
    
    if (lwip_connect(sockfd,(struct sockaddr *)&serv_addr,sizeof(serv_addr)) < 0){
        rtl_printf("[ERROR] connect failed\n");
        return ;
    }
    
    
    rtl_sprintf(message,"%s",http_get_header("www.google.com.tw","/"));
    rtl_printf("\nRequest:\n%s\n",message);
    bytes = lwip_write(sockfd,message,256);
    if (bytes < 0)
        rtl_printf("[ERROR] send packet failed\n");
    
    
    response = pvPortMalloc(1500);
    if(response ==0)
        rtl_printf("[ERROR] malloc failed\n");
    rtl_printf("Response:\n");
    do {
        _memset(response, 0, 1500);
        bytes = lwip_read(sockfd,response,1500-1);
        if (bytes < 0)
            rtl_printf("[ERROR] receive packet failed\n");
        if (bytes == 0)
            break;
        rtl_printf("%s",response);
    } while (bytes > 0);
...
void example_http_client(void)
{
    if(xTaskGenericCreate( ( http_client_thread ), ( ((const char*)"http_client_thread") ), ( 1024 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
