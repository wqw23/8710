#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpc\\example_httpc.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpc\\example_httpc.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpc\\example_httpc.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpc\\example_httpc.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\httpc\\example_httpc.c"
...
static void example_httpc_thread(void *param)
{
	...
	conn = httpc_conn_new(0, 0, 0, 0);

	if(conn) {



		if(httpc_conn_connect(conn, "httpbin.org", 80, 0) == 0) {

			 
			
			httpc_request_write_header_start(conn, "GET", "/get?param1=test_data1&param2=test_data2", 0, 0);
	...
	if(conn) {
		...
		if(httpc_conn_connect(conn, "httpbin.org", 80, 0) == 0) {
			...
			httpc_request_write_header_start(conn, "POST", "/post", 0, prvStrLen((const unsigned char *) post_data));
			
			httpc_request_write_header(conn, "Connection", "close");
			
			httpc_request_write_header_finish(conn);
			
			httpc_request_write_data(conn, post_data, prvStrLen((const unsigned char *) post_data));
...
{
	if(xTaskGenericCreate( ( example_httpc_thread ), ( ((const char*)"example_httpc_thread") ), ( 2048 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
