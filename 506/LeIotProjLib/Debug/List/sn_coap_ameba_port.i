...
#line 11 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 12 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 13 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 14 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 15 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 16 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 17 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 18 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 19 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
#line 1 "D:\\1\\IAR\\arm\\inc\\c\\stdint.h"
...
#line 20 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 22 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\coap\\include\\sn_coap_ameba_port.h"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\coap\\sn_coap_ameba_port.c"
...
int coap_sock_open(){
	...
	int socket_fd = lwip_socket(2,2,0);
...
int coap_sock_close(int socket_fd){
	int r = lwip_close(socket_fd);

#line 69 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\coap\\sn_coap_ameba_port.c"
...
int coap_send(char *to_address, uint16_t port, int socket, sn_coap_hdr_s *coap_msg_hdr){
	...
	_memset((char *) &internet_address, 0, sizeof(internet_address));

	internet_address.sin_family = 2;
	internet_address.sin_port = lwip_htons(port);
	

	struct hostent *host_entry;

	host_entry = lwip_gethostbyname(to_address);

	_memcpy((void *) &internet_address . sin_addr, (void *) host_entry->h_addr_list[0], host_entry->h_length);

	int n = lwip_sendto(socket,message_ptr,message_len,0,(struct sockaddr *)&internet_address,sizeof(internet_address));
...
#line 122 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\coap\\sn_coap_ameba_port.c"

	uint32_t addr_len = sizeof(struct sockaddr_in);

	return lwip_recvfrom(socket,buf,buf_size,0,(struct sockaddr *) from_address,&addr_len);
}
...
void coap_print_hdr(sn_coap_hdr_s* parsed_hdr){
	...
	rtl_sprintf(code, "%d.%.2x", cat, dd);

	rtl_printf("\ttoken_len:            %d\n", parsed_hdr->token_len);
	rtl_printf("\ttoken_ptr:            %s\n", parsed_hdr->token_ptr);
    
    rtl_printf("\tcoap_status:          %d ", parsed_hdr->coap_status);
	switch(parsed_hdr->coap_status){

		case COAP_STATUS_OK:
		rtl_printf("COAP_STATUS_OK\n");
		break;

		case COAP_STATUS_PARSER_ERROR_IN_HEADER:
		rtl_printf("COAP_STATUS_PARSER_ERROR_IN_HEADER\n");
		break;

		case COAP_STATUS_PARSER_DUPLICATED_MSG:
		rtl_printf("COAP_STATUS_PARSER_DUPLICATED_MSG\n");
		break;

		case COAP_STATUS_PARSER_BLOCKWISE_MSG_RECEIVING:
		rtl_printf("COAP_STATUS_PARSER_BLOCKWISE_MSG_RECEIVING\n");
		break;

		case COAP_STATUS_PARSER_BLOCKWISE_ACK:
		rtl_printf("COAP_STATUS_PARSER_BLOCKWISE_ACK\n");
		break;

		case COAP_STATUS_PARSER_BLOCKWISE_MSG_REJECTED:
		rtl_printf("COAP_STATUS_PARSER_BLOCKWISE_MSG_REJECTED\n");
		break;

		case COAP_STATUS_PARSER_BLOCKWISE_MSG_RECEIVED:
		rtl_printf("COAP_STATUS_PARSER_BLOCKWISE_MSG_RECEIVED\n");
		break;

		case COAP_STATUS_BUILDER_MESSAGE_SENDING_FAILED:
		rtl_printf("COAP_STATUS_BUILDER_MESSAGE_SENDING_FAILED\n");
		break;
	...
	rtl_printf("\tmsg_code:             %s ", code);
	switch(parsed_hdr->msg_code){

		case COAP_MSG_CODE_EMPTY:
		rtl_printf("COAP_MSG_CODE_EMPTY\n");
		break;

		case COAP_MSG_CODE_REQUEST_GET:
		rtl_printf("COAP_MSG_CODE_REQUEST_GET\n");
		break;

		case COAP_MSG_CODE_REQUEST_POST:
		rtl_printf("COAP_MSG_CODE_REQUEST_POST\n");
		break;

		case COAP_MSG_CODE_REQUEST_PUT:
		rtl_printf("COAP_MSG_CODE_REQUEST_PUT\n");
		break;

		case COAP_MSG_CODE_REQUEST_DELETE:
		rtl_printf("COAP_MSG_CODE_REQUEST_DELETE\n");
		break;

		case COAP_MSG_CODE_RESPONSE_CREATED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_CREATED\n");
		break;

		case COAP_MSG_CODE_RESPONSE_DELETED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_DELETED\n");
		break;

		case COAP_MSG_CODE_RESPONSE_VALID:
		rtl_printf("COAP_MSG_CODE_RESPONSE_VALID\n");
		break;

		case COAP_MSG_CODE_RESPONSE_CHANGED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_CHANGED\n");
		break;

		case COAP_MSG_CODE_RESPONSE_CONTENT:
		rtl_printf("COAP_MSG_CODE_RESPONSE_CONTENT\n");
		break;

		case COAP_MSG_CODE_RESPONSE_CONTINUE:
		rtl_printf("COAP_MSG_CODE_RESPONSE_CONTINUE\n");
		break;

		case COAP_MSG_CODE_RESPONSE_BAD_REQUEST:
		rtl_printf("COAP_MSG_CODE_RESPONSE_BAD_REQUEST\n");
		break;

		case COAP_MSG_CODE_RESPONSE_UNAUTHORIZED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_UNAUTHORIZED\n");
		break;

		case COAP_MSG_CODE_RESPONSE_BAD_OPTION:
		rtl_printf("COAP_MSG_CODE_RESPONSE_BAD_OPTION\n");
		break;

		case COAP_MSG_CODE_RESPONSE_FORBIDDEN:
		rtl_printf("COAP_MSG_CODE_RESPONSE_FORBIDDEN\n");
		break;

		case COAP_MSG_CODE_RESPONSE_NOT_FOUND:
		rtl_printf("COAP_MSG_CODE_RESPONSE_NOT_FOUND\n");
		break;

		case COAP_MSG_CODE_RESPONSE_METHOD_NOT_ALLOWED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_METHOD_NOT_ALLOWED\n");
		break;

		case COAP_MSG_CODE_RESPONSE_NOT_ACCEPTABLE:
		rtl_printf("COAP_MSG_CODE_RESPONSE_NOT_ACCEPTABLE\n");
		break;

		case COAP_MSG_CODE_RESPONSE_REQUEST_ENTITY_INCOMPLETE:
		rtl_printf("COAP_MSG_CODE_RESPONSE_REQUEST_ENTITY_INCOMPLETE\n");
		break;

		case COAP_MSG_CODE_RESPONSE_PRECONDITION_FAILED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_PRECONDITION_FAILED\n");
		break;

		case COAP_MSG_CODE_RESPONSE_REQUEST_ENTITY_TOO_LARGE:
		rtl_printf("COAP_MSG_CODE_RESPONSE_REQUEST_ENTITY_TOO_LARGE\n");
		break;

		case COAP_MSG_CODE_RESPONSE_UNSUPPORTED_CONTENT_FORMAT:
		rtl_printf("COAP_MSG_CODE_RESPONSE_UNSUPPORTED_CONTENT_FORMAT\n");
		break;

		case COAP_MSG_CODE_RESPONSE_INTERNAL_SERVER_ERROR:
		rtl_printf("COAP_MSG_CODE_RESPONSE_INTERNAL_SERVER_ERROR\n");
		break;

		case COAP_MSG_CODE_RESPONSE_NOT_IMPLEMENTED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_NOT_IMPLEMENTED\n");
		break;

		case COAP_MSG_CODE_RESPONSE_BAD_GATEWAY:
		rtl_printf("COAP_MSG_CODE_RESPONSE_BAD_GATEWAY\n");
		break;

		case COAP_MSG_CODE_RESPONSE_SERVICE_UNAVAILABLE:
		rtl_printf("COAP_MSG_CODE_RESPONSE_SERVICE_UNAVAILABLE\n");
		break;

		case COAP_MSG_CODE_RESPONSE_GATEWAY_TIMEOUT:
		rtl_printf("COAP_MSG_CODE_RESPONSE_GATEWAY_TIMEOUT\n");
		break;

		case COAP_MSG_CODE_RESPONSE_PROXYING_NOT_SUPPORTED:
		rtl_printf("COAP_MSG_CODE_RESPONSE_PROXYING_NOT_SUPPORTED\n");
		break;
	...
	rtl_printf("\tmsg_type:             %.2x ", parsed_hdr->msg_type);
	switch(parsed_hdr->msg_type){

		case COAP_MSG_TYPE_CONFIRMABLE:
		rtl_printf("COAP_MSG_TYPE_CONFIRMABLE\n");
		break;

		case COAP_MSG_TYPE_NON_CONFIRMABLE:
		rtl_printf("COAP_MSG_TYPE_NON_CONFIRMABLE\n");
		break;

		case COAP_MSG_TYPE_ACKNOWLEDGEMENT:
		rtl_printf("COAP_MSG_TYPE_ACKNOWLEDGEMENT\n");
		break;

		case COAP_MSG_TYPE_RESET:
		rtl_printf("COAP_MSG_TYPE_RESET\n");
		break;
	...
	rtl_printf("\tcontent_format:       %d ", parsed_hdr->content_format);
	switch(parsed_hdr->content_format){
		case COAP_CT_NONE:
		rtl_printf("COAP_CT_NONE\n");
		break;

		case COAP_CT_TEXT_PLAIN:
		rtl_printf("COAP_CT_TEXT_PLAIN\n");
		break;

		case COAP_CT_LINK_FORMAT:
		rtl_printf("COAP_CT_LINK_FORMAT\n");
		break;

		case COAP_CT_XML:
		rtl_printf("COAP_CT_XML\n");
		break;

		case COAP_CT_OCTET_STREAM:
		rtl_printf("COAP_CT_OCTET_STREAM\n");
		break;

		case COAP_CT_EXI:
		rtl_printf("COAP_CT_EXI\n");
		break;

		case COAP_CT_JSON:
		rtl_printf("COAP_CT_JSON\n");
		break;

		case COAP_CT__MAX:
		rtl_printf("COAP_CT__MAX\n");
		break;
    ...
    rtl_printf("\turi_path_len:         %d\n", parsed_hdr->uri_path_len);
    rtl_printf("\turi_path_ptr:         %s\n", parsed_hdr->uri_path_ptr);

    rtl_printf("\tpayload_len:          %d\n", parsed_hdr->payload_len);
    rtl_printf("\tpayload_ptr:          %s\n", parsed_hdr->payload_ptr);
