#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
...
#line 18 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
...
#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\device.h"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
...
#line 20 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
...
#line 21 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
...
#line 22 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
...
static uint32_t serial_irq_ids[(3)] = {0, 0, 0};

static uart_irq_handler irq_handler[(3)];
static uint32_t serial_irq_en[(3)]={0, 0, 0};


static uint32_t serial_dma_en[(3)] = {0, 0, 0};


MBED_UART_ADAPTER uart_adapter[(2)+1];
...
static const PinMap PinMap_UART_TX[] = {
	{PA_4,		UART_0,		(((PullUp) << 6) | ((1)))},
	{PA_23,		UART_0,		(((PullUp) << 6) | ((1)))},
	{PA_26,		UART_1,		(((PullUp) << 6) | ((1)))},
	{PA_17,		UART_2,		(((PullUp) << 6) | ((1)))},
	{PA_30,		UART_2,		(((PullUp) << 6) | ((1)))},
	{NC,		NC,			0}
};

static const PinMap PinMap_UART_RX[] = {
	{PA_1,		UART_0,		(((PullUp) << 6) | ((1)))},
	{PA_18,		UART_0,		(((PullUp) << 6) | ((1)))},
	{PA_25,		UART_1,		(((PullUp) << 6) | ((1)))},
	{PA_16,		UART_2,		(((PullUp) << 6) | ((1)))},
	{PA_29,		UART_2,		(((PullUp) << 6) | ((1)))},
	{NC,		NC,			0}
};
...
uart_index_get(PinName tx)
{
	if ((tx == (0x04)) || (tx == (0x17))) {
		...
		return 1;
	} else if ((tx == (0x11)) || (tx == (0x1E))) {
		return 2;
	} else {
		((0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 105));
	}
        return 3;
}
...
)
{
	...
	GDMA_ChCleanAutoReload(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum, ((uint32_t)0x00000002));

	
	IsrTypeMap = GDMA_ClearINT(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum);

	 
	UART_TXDMACmd(puart_adapter->UARTx, 0);

	GDMA_Cmd(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum, 0);
	GDMA_ChnlFree(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum);

	UART_SetTxFlag(puart_adapter->UartIndex, 0);

	
	if (0 != puart_adapter->TxCompCallback) {
...
)
{
	...
	GDMA_ChCleanAutoReload(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum, ((uint32_t)0x00000001));

	
	IsrTypeMap = GDMA_ClearINT(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum);

	 
	UART_RXDMACmd(puart_adapter->UARTx, 0);

	GDMA_Cmd(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum, 0);
	GDMA_ChnlFree(GDMA_InitStruct->GDMA_Index, GDMA_InitStruct->GDMA_ChNum);

	
	LineStatus = (uint8_t)UART_LineStatusGet(puart_adapter->UARTx);

	UART_SetRxFlag(puart_adapter->UartIndex, 0);

	 
	UART_INTConfig(puart_adapter->UARTx, ((uint32_t)0x00000001) | ((uint32_t)0x00000001<<2) |((uint32_t)0x00000001<<5), 0);
	
	
	if (puart_adapter->RxCompCallback != 0) {
...
static void uart_txdone_callback(void *pAdapter)
{
	...
	uint8_t uart_idx = puart_adapter->UartIndex;

	
	UART_INTConfig(puart_adapter->UARTx, ((uint32_t)0x00000001<<1), 0);

	if (irq_handler[uart_idx] != 0) {
...
)
{
	...
	if ((reg_iir & ((uint32_t)0x00000001)) != 0) {
		
		return 0;
	}

	IntId = (reg_iir & ((uint32_t)0x00000007<<1)) >> 1;
	...
	case ((uint32_t)0x00000001):
		if (UART_GetTxFlag(puart_adapter->UartIndex)) {
			uint32_t TransCnt = UART_SendDataTO(puart_adapter->UARTx, puart_adapter->pTxBuf,
	...
	case ((uint32_t)0x00000006):
		if (UART_GetRxFlag(puart_adapter->UartIndex) == 2) {
			uint32_t TransCnt = 0;
			...
			RegValue = (UART_LineStatusGet(puart_adapter->UARTx));
			if (RegValue & ((uint32_t)0x00000001)) {
	...
	default:
		do { if ((LEVEL_ERROR < LEVEL_NUMs) && (MODULE_UART < MODULE_NUMs) && (ConfigDebug[LEVEL_ERROR] & (1<<(MODULE_UART)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "Unknown Interrupt \n"; } }while(0);
	break;
	}
...
#line 426 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
...
void serial_init(serial_t *obj, PinName tx, PinName rx) 
{
	...
	PMBED_UART_ADAPTER puart_adapter = 0;

	((UARTx != (UARTName)NC) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 442));
	...
	VECTOR_IrqRegister((IRQ_FUN)uart_irqhandler, puart_adapter->IrqNum, (uint32_t)puart_adapter, 10);
	VECTOR_IrqEn(puart_adapter->IrqNum, 10);

	 
	switch (puart_adapter->UartIndex) {
	case 0:
		 
		RCC_PeriphClockCmd(((1<<(0)) | 2 << 30), ((1<<(0)) | (1<<29)), 1);
	break;

	case 1:
		 
		RCC_PeriphClockCmd(((1<<(1)) | 2 << 30), ((1<<(2)) | (1<<29)), 1);
	break;
	default:
	break;
	}
...
#line 483 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c"
}
...
void serial_free(serial_t *obj) 
{
	...
	VECTOR_IrqDis(puart_adapter->IrqNum);
	VECTOR_IrqUnRegister(puart_adapter->IrqNum);
...
void serial_baud(serial_t *obj, int baudrate)
{
	...
	UART_RxCmd(puart_adapter->UARTx, 1);

	if (baudrate <= 500000) {
		if (uart_config[obj->uart_idx].LOW_POWER_RX_ENABLE) {
			LPUART_InitTypeDef LPUART_InitStruct;
			
			UART_LPRxpathSet(puart_adapter->UARTx, 1);
			UART_LPRxIPClockSet(puart_adapter->UARTx, ((uint32_t)0x00000001));
			UART_LPRxStructInit(&LPUART_InitStruct);
			UART_LPRxInit(puart_adapter->UARTx, &LPUART_InitStruct);
			UART_LPRxMonitorCmd(puart_adapter->UARTx, 1);
			UART_LPRxBaudSet(puart_adapter->UARTx, baudrate, (8388608));
			UART_LPRxCmd(puart_adapter->UARTx, 1);
		}
	}
}
...
void serial_format(serial_t *obj, int data_bits, SerialParity parity, int stop_bits) 
{
	...
	UART_RxCmd(puart_adapter->UARTx, 0);
    
	if (data_bits == 8) {
		puart_adapter->UART_InitStruct.WordLen = ((uint32_t)0x00000001);
	} else {
		puart_adapter->UART_InitStruct.WordLen = ((uint32_t)0x00000000);
	}

	switch (parity) {
	case ParityOdd:
	case ParityForced0:
		puart_adapter->UART_InitStruct.Parity = ((uint32_t)0x00000001);
		puart_adapter->UART_InitStruct.ParityType = ((uint32_t)0x00000000);
	break;
	case ParityEven:
	case ParityForced1:
		puart_adapter->UART_InitStruct.Parity = ((uint32_t)0x00000001);
		puart_adapter->UART_InitStruct.ParityType = ((uint32_t)0x00000001);
	break;
	default: 
		puart_adapter->UART_InitStruct.Parity = ((uint32_t)0x00000000);
	break;
	}

	if (stop_bits == 2) {
		puart_adapter->UART_InitStruct.StopBit = ((uint32_t)0x00000001);
	} else {
		puart_adapter->UART_InitStruct.StopBit = ((uint32_t)0x00000000);
	}
...
void serial_irq_set(serial_t *obj, SerialIrq irq, uint32_t enable) 
{
	...
	if (enable) {
		if (irq == RxIrq) {
			serial_irq_en[uart_idx] |= 0x02;
			UART_INTConfig(puart_adapter->UARTx, ((uint32_t)0x00000001) | ((uint32_t)0x00000001<<2) | ((uint32_t)0x00000001<<5), 1);
		}
		else {
			serial_irq_en[uart_idx] |= 0x01;
		}
	} 
	else { 
		if (irq == RxIrq) {
...
void serial_putc(serial_t *obj, int c) 
{
	...
	if (serial_irq_en[obj->uart_idx] & 0x01) {
		
		UART_INTConfig(puart_adapter->UARTx, ((uint32_t)0x00000001<<1), 1);
	}
}
...
int32_t serial_recv_stream (serial_t *obj, char *prxbuf, uint32_t len)
{
	...
	((prxbuf != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 835));
	((len != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 836));
	
	if (UART_GetRxFlag(puart_adapter->UartIndex)) {
		do { if ((LEVEL_WARN < LEVEL_NUMs) && (MODULE_UART < MODULE_NUMs) && (ConfigDebug[LEVEL_WARN] & (1<<(MODULE_UART)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "uart int rx: busy\n"; } }while(0);
		return HAL_BUSY;
	}
	...
	UART_SetRxFlag(puart_adapter->UartIndex, 2);
...
int32_t serial_send_stream (serial_t *obj, char *ptxbuf, uint32_t len)
{
	...
	((ptxbuf != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 879));
	((len != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 880));
	
	if (UART_GetTxFlag(puart_adapter->UartIndex)) {
		do { if ((LEVEL_WARN < LEVEL_NUMs) && (MODULE_UART < MODULE_NUMs) && (ConfigDebug[LEVEL_WARN] & (1<<(MODULE_UART)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "uart int tx: busy\n"; } }while(0);
		return HAL_BUSY;
	}
	...
	UART_SetTxFlag(puart_adapter->UartIndex, 2);
...
int32_t serial_recv_stream_dma (serial_t *obj, char *prxbuf, uint32_t len)
{
	...
	((prxbuf != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 928));
	((len != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 929));
	
	if (UART_GetRxFlag(puart_adapter->UartIndex)) {
		do { if ((LEVEL_WARN < LEVEL_NUMs) && (MODULE_UART < MODULE_NUMs) && (ConfigDebug[LEVEL_WARN] & (1<<(MODULE_UART)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "uart dma rx: busy\n"; } }while(0);
		return HAL_BUSY;
	}
	...
	puart_adapter->pRxBuf = (uint8_t*)prxbuf;
	puart_adapter->RxCount = len;
	puart_adapter->last_dma_addr = (uint32_t)prxbuf;

	UART_SetRxFlag(puart_adapter->UartIndex, 1);

	
	UART_INTConfig(puart_adapter->UARTx, (((uint32_t)0x00000001) | ((uint32_t)0x00000001<<2) | ((uint32_t)0x00000001<<5)), 0);
	UART_RXDMAConfig(puart_adapter->UARTx, 4);
	UART_RXDMACmd(puart_adapter->UARTx, 1);
	...
	if ((serial_dma_en[obj->uart_idx] & 0x02)==0) {
		if(ret1 == (!0)) {
			serial_dma_en[obj->uart_idx] |= 0x02;
		} else {
			return HAL_BUSY;
...
int32_t serial_send_stream_dma (serial_t *obj, char *ptxbuf, uint32_t len)
{
	...
	((ptxbuf != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 986));
	((len != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 987));

	if (UART_GetTxFlag(puart_adapter->UartIndex)) {
		do { if ((LEVEL_WARN < LEVEL_NUMs) && (MODULE_UART < MODULE_NUMs) && (ConfigDebug[LEVEL_WARN] & (1<<(MODULE_UART)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "uart dma tx: busy\n"; } }while(0);
		return HAL_BUSY;
	}
	...
	UART_SetTxFlag(puart_adapter->UartIndex, 1);

	UART_TXDMAConfig(puart_adapter->UARTx, 8);
	UART_TXDMACmd(puart_adapter->UARTx, 1);
	...
	if ((serial_dma_en[obj->uart_idx] & 0x01)==0) {
		if(ret1 == (!0)) {
			serial_dma_en[obj->uart_idx] |= 0x01;
		} else {
			return HAL_BUSY;
...
int32_t serial_send_stream_abort (serial_t *obj)
{
	...
	if(UART_GetTxFlag(puart_adapter->UartIndex) == 1) {
		if (uart_config[obj->uart_idx].LOW_POWER_RX_ENABLE == 0) {
			...
			puart_adapter->TxCount = puart_adapter->TxCount - (Current_Addr - (uint32_t)puart_adapter->pTxBuf);
			puart_adapter->pTxBuf = (uint8_t*)Current_Addr;
...
int32_t serial_recv_stream_abort (serial_t *obj)
{
	...
	if(UART_GetRxFlag(puart_adapter->UartIndex) == 1) {
		if (uart_config[obj->uart_idx].LOW_POWER_RX_ENABLE == 0) {
			uint32_t Current_Addr;
			uint32_t TransCnt;
			...
			puart_adapter->RxCount = puart_adapter->RxCount - (Current_Addr - (uint32_t)puart_adapter->pRxBuf);
			puart_adapter->pRxBuf = (uint8_t*)Current_Addr;
...
void serial_disable (serial_t *obj)
{
	...
	case 0:
		...
		RCC_PeriphClockCmd(((1<<(0)) | 2 << 30), ((1<<(0)) | (1<<29)), 0);
	break;

	case 1:
		 
		RCC_PeriphClockCmd(((1<<(1)) | 2 << 30), ((1<<(2)) | (1<<29)), 0);
	break;
	default:
	break;
	}
	...
	void *force_cs)
{
	...
	((prxbuf != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1278));
	((len != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1279));
	((timeout_ms > 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1280));
	...
	if (puart_adapter->RxCount == 0) {
		...
		UART_INTConfig(UARTx, ((uint32_t)0x00000001) | ((uint32_t)0x00000001<<2) | ((uint32_t)0x00000001<<5), 1);
	}
	...
	if (puart_adapter->RxCount > 0) {
		...
		while (1) {
			...
			if (UART_GetRxFlag(obj->uart_idx) != 2) {
				break;
			}
	...
	void *force_cs)
{
	...
	((prxbuf != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1354));
	((len != 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1355));
	((timeout_ms > 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1356));
	...
	if (puart_adapter->RxCount > 0) {
		...
		while (1) {
			...
			if (UART_GetRxFlag(obj->uart_idx) != 1) {
				break;
			}
			...
			if (SYSTIMER_GetPassTime(startcount) > timeout_ms) {
				...
				if ((current_dst_addr != (uint32_t)(puart_adapter->pRxBuf)) || data_in_fifo) {			
					puart_adapter->RxCount = puart_adapter->RxCount - (current_dst_addr - (uint32_t)puart_adapter->pRxBuf);
					puart_adapter->pRxBuf = (uint8_t*)current_dst_addr;
...
void serial_rx_fifo_level(serial_t *obj, SerialFifoLevel FifoLv)
{
	...
	switch(FifoLv) {
		case FifoLv1Byte:
			Temp = ((uint32_t)0x00000000);
		break;
		case FifoLvQuarter:
			Temp = ((uint32_t)0x00000040);
		break;
		case FifoLvHalf:
			Temp = ((uint32_t)0x00000080);
		break;
		case FifoLvFull:
			Temp = ((uint32_t)0x000000c0);
		break;		
		default:
			((0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1450));
		break;
	}
...
void serial_set_flow_control(serial_t *obj, FlowControl type, PinName rxflow, PinName txflow)
{
	...
	((obj->uart_idx == 0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1472));
	...
	if(type != FlowControlNone) {
		...
		if(rxflow == PA_3) {
			...
			Pinmux_Config((0x03), (1));	 
			Pinmux_Config((0x02), (1));	 
		} else if (rxflow == PA_22) {
			 
			Pinmux_Config((0x16), (1)); 	 
			Pinmux_Config((0x13), (1)); 	 
		} else {
			((0) ? (void)0 : io_assert_failed((uint8_t *)"D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\serial_api.c", 1486));
		}
