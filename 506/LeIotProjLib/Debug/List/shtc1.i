#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
#line 18 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\os\\freertos\\freertos_service.h"
...
#line 9 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal\\i2c_api.h"
...
#line 10 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
#line 11 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
#line 12 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
static uint8_t i2cdata_write[16];
static uint8_t i2cdata_read[16];
static int i2cdata_read_pos;

static i2c_t   i2cmaster;


#line 42 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\application\\wigadget\\shtc1.c"
...
int SHTC_Init(uint16_t *pID)
{
	...
	i2c_init((i2c_t*)&i2cmaster, PA_19 ,PA_22);
	i2c_frequency((i2c_t*)&i2cmaster,100000);
...
static int SHTC1_GetID(uint16_t *id)
{
	...
	SHTC1_WriteCommand(0xEFC8);  

	i2c_read((i2c_t*)&i2cmaster, 0x70, (char*)&i2cdata_read[0], 3, 1);
	i2cdata_read_pos = 0;
...
static void SHTC1_WriteCommand(uint16_t cmd)
{
	...
	i2cdata_write[1] = (uint8_t)(cmd&0xFF);
  	i2c_write((i2c_t*)&i2cmaster, 0x70, &i2cdata_write[0], 2, 1);
}  
...
int SHTC_GetTempAndHumi(float *temp, float *humi)
{
	...
	SHTC1_WriteCommand(0x7CA2);  

	i2c_read((i2c_t*)&i2cmaster, 0x70, (char*)&i2cdata_read[0], 6, 1);
	i2cdata_read_pos = 0;
	error = 0x00;
...
static void example_shtc1_thread(void *param)
{
	...
	do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "sleep 10 sec. to wait for UART console\n");}while(0);
	rtw_msleep_os(10000);
	do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "start i2c example - SHTC1\n");}while(0);
...
void example_shtc1(void)
{
	if(xTaskGenericCreate( ( example_shtc1_thread ), ( ((const char*)"example_shtc1_thread") ), ( 512 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
