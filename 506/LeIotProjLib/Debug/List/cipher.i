...
#line 35 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/cipher.h"
...
#line 56 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/cipher.h"

#line 63 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/cipher.h"
...
#line 569 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/cipher.h"
...
#line 651 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/cipher.h"
...
#line 748 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/cipher.h"
...
const cipher_info_t *cipher_info_from_type( const cipher_type_t cipher_type )
{
    ...
    for( def = cipher_definitions; def->info != 0; def++ )
...
void cipher_init( cipher_context_t *ctx )
{
    _memset(ctx, 0, sizeof( cipher_context_t ));
}
                   ...
                   const unsigned char *iv, size_t iv_len )
{
    ...
    if( 0 == ctx || 0 == ctx->cipher_info || 0 == iv )
        return( -0x6100 );
    ...
    _memcpy(ctx->iv, iv, actual_iv_size);
...
#line 266 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\cipher.c"
                   ...
                   size_t ilen, unsigned char *output, size_t *olen )
{
    ...
    if( 0 == ctx || 0 == ctx->cipher_info || 0 == olen )
    {
        return( -0x6100 );
    }
...
#line 303 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\cipher.c"
    ...
    if( ctx->cipher_info->mode == POLARSSL_MODE_CBC )
    {
        ...
        if( ( ctx->operation == POLARSSL_DECRYPT &&
             ...
             ( ctx->operation == POLARSSL_ENCRYPT &&
                ilen + ctx->unprocessed_len < cipher_get_block_size( ctx ) ) )
        {
            _memcpy(&( ctx->unprocessed_data[ctx->unprocessed_len] ), input, ilen);
        ...
        if( ctx->unprocessed_len != 0 )
        {
            ...
            _memcpy(&( ctx->unprocessed_data[ctx->unprocessed_len] ), input, copy_len);
        ...
        if( 0 != ilen )
        {
            ...
            _memcpy(ctx->unprocessed_data, &( input[ilen - copy_len] ), copy_len);
...
#line 793 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\cipher.c"
...
#line 916 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\cipher.c"
