...
#line 149 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\mem.c"
...
u8_t ram_heap[((((5*1024)) + 4 - 1) & ~(4-1)) + (2*(((sizeof(struct mem)) + 4 - 1) & ~(4-1))) + 4];
...
#line 211 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\mem.c"
...
plug_holes(struct mem *mem)
{
  ...
  do { if(!(mem->next <= ((((5*1024)) + 4 - 1) & ~(4-1)))) ; } while(0);
...
mem_init(void)
{
  ...
  mem->next = ((((5*1024)) + 4 - 1) & ~(4-1));
  mem->prev = 0;
  mem->used = 0;
   
  ram_end = (struct mem *)(void *)&ram[((((5*1024)) + 4 - 1) & ~(4-1))];
  ram_end->used = 1;
  ram_end->next = ((((5*1024)) + 4 - 1) & ~(4-1));
  ram_end->prev = ((((5*1024)) + 4 - 1) & ~(4-1));
...
mem_free(void *rmem)
{
  ...
  if (rmem == 0) {
    do { if ( ((0x00U | 0x40U | 0x02) & 0x80U) && ((0x00U | 0x40U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x02) & 0x03) >= 0x00)) { rtl_printf ("mem_free(p == NULL) was called.\n"); if ((0x00U | 0x40U | 0x02) & 0x08U) { while(1); } } } while(0);
    return;
  }
  ...
  if ((u8_t *)rmem < (u8_t *)ram || (u8_t *)rmem >= (u8_t *)ram_end) {
    sys_prot_t lev;
    do { if ( ((0x00U | 0x03) & 0x80U) && ((0x00U | 0x03) & 0x80U) && ((s16_t)((0x00U | 0x03) & 0x03) >= 0x00)) { rtl_printf ("mem_free: illegal memory\n"); if ((0x00U | 0x03) & 0x08U) { while(1); } } } while(0);
...
mem_trim(void *rmem, mem_size_t newsize)
{
  ...
  if ((u8_t *)rmem < (u8_t *)ram || (u8_t *)rmem >= (u8_t *)ram_end) {
    sys_prot_t lev;
    do { if ( ((0x00U | 0x03) & 0x80U) && ((0x00U | 0x03) & 0x80U) && ((s16_t)((0x00U | 0x03) & 0x03) >= 0x00)) { rtl_printf ("mem_trim: illegal memory\n"); if ((0x00U | 0x03) & 0x08U) { while(1); } } } while(0);
...
mem_malloc(mem_size_t size)
{
  ...
  ;
    ...
    for (ptr = (mem_size_t)((u8_t *)lfree - ram); ptr < ((((5*1024)) + 4 - 1) & ~(4-1)) - size;
         ptr = ((struct mem *)(void *)&ram[ptr])->next) {
      mem = (struct mem *)(void *)&ram[ptr];
#line 547 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\mem.c"
...
#line 607 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\lwip\\lwip_v1.4.1\\src\\core\\mem.c"
  ...
  do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { rtl_printf ("mem_malloc: could not allocate %" "d" " bytes\n", (s16_t)size); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
  ;
  ;
  sys_sem_signal(&mem_mutex);
  return 0;
