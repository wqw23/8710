                                    ...
                                    size_t *olen )
{
    ...
    *p++ = (unsigned char)( ( ssl->hostname_len      ) & 0xFF );
    ...
    _memcpy(p, ssl->hostname, ssl->hostname_len);
                                                ...
                                                size_t *olen )
{
    ...
    *olen = 0;
    ...
    sig_alg_list[sig_alg_len++] = 6;
    sig_alg_list[sig_alg_len++] = 1;
    sig_alg_list[sig_alg_len++] = 5;
    sig_alg_list[sig_alg_len++] = 1;


    sig_alg_list[sig_alg_len++] = 4;
    sig_alg_list[sig_alg_len++] = 1;
    sig_alg_list[sig_alg_len++] = 3;
    sig_alg_list[sig_alg_len++] = 1;


    sig_alg_list[sig_alg_len++] = 2;
    sig_alg_list[sig_alg_len++] = 1;


    sig_alg_list[sig_alg_len++] = 1;
    sig_alg_list[sig_alg_len++] = 1;
#line 210 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 311 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
                                          ...
                                          unsigned char *buf, size_t *olen )
{
    ...
    *olen = 4;
    ...
    if( ssl->session_negotiate->ticket == 0 ||
    ...
    _memcpy(p, ssl->session_negotiate ->ticket, tlen);

    *olen += tlen;
}


#line 446 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 504 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
    ...
    if( ssl->renegotiation != 0 || n < 16 || n > 32 ||
    ...
    if( ssl->renegotiation == 0 &&
        ssl->session_negotiate->ticket != 0 &&
        ssl->session_negotiate->ticket_len != 0 )
    {
...
#line 614 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
    do { } while( 0 );
    do { } while( 0 );
...
#line 643 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 825 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 947 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
    ...
    if( ssl->transform_negotiate->ciphersuite_info == 0 )
    {
        do { } while( 0 );
        return( -0x7100 );
    }
    ...
    if( ssl->renegotiation != 0 ||
        ...
        _memcmp(ssl->session_negotiate ->id, buf + 39, n) != 0 )
    {
        ssl->state++;
        ssl->handshake->resume = 0;
        ...
        ssl->session_negotiate->compression = comp;
        ssl->session_negotiate->length = n;
        _memcpy(ssl->session_negotiate ->id, buf + 39, n);
    }
    else
    {
...
#line 1144 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"

#line 1154 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 1251 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"

#line 1287 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"

#line 1323 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"

#line 1355 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 1475 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"


#line 1510 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
static int ssl_parse_server_key_exchange( ssl_context *ssl )
{
    ...
    unsigned char *p, *end;
#line 1525 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 1558 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 1605 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"

#line 1645 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
    {
        do { } while( 0 );
        return( -0x6C00 );
    }

#line 1816 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 1849 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
...
#line 1949 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
        {
            ;  
        }
...
#line 2221 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
    if( ciphersuite_info->key_exchange == POLARSSL_KEY_EXCHANGE_RSA )
    {
        i = 4;
...
#line 2282 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\library\\ssl_cli.c"
static int ssl_write_certificate_verify( ssl_context *ssl )
{
    ...
    if( ssl->client_auth == 0 || ssl_own_cert( ssl ) == 0 )
    {
        do { } while( 0 );
        ssl->state++;
        return( 0 );
...
static int ssl_parse_new_session_ticket( ssl_context *ssl )
{
    ...
    rom_ssl_ram_map . ssl_free( ssl->session_negotiate->ticket );
    ssl->session_negotiate->ticket = 0;
    ssl->session_negotiate->ticket_len = 0;

    if( ( ticket = rom_ssl_ram_map . ssl_malloc( ticket_len ) ) == 0 )
    {
        do { } while( 0 );
        return( -0x7F00 );
    }

    _memcpy(ticket, ssl->in_msg + 10, ticket_len);
