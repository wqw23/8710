#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 2 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 3 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 4 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 5 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 11 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 12 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 13 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\network\\ssl\\polarssl-1.3.8\\include\\polarssl/certs.h"
...
#line 14 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 15 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
#line 46 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
	...
	_memset(&server_x509, 0, sizeof(x509_crt));
	_memset(&server_pk, 0, sizeof(pk_context));
	...
	if((ret = x509_crt_parse(&server_x509, (const unsigned char *)test_srv_crt, prvStrLen((const unsigned char *) test_srv_crt))) != 0) {
		rtl_printf(" failed\n  ! x509_crt_parse returned %d\n\n", ret);
		goto exit;
	}

	if((ret = x509_crt_parse(&server_x509, (const unsigned char *)test_ca_list, prvStrLen((const unsigned char *) test_ca_list))) != 0) {
		rtl_printf(" failed\n  ! x509_crt_parse returned %d\n\n", ret);
		goto exit;
	}

	if((ret = pk_parse_key(&server_pk, test_srv_key, prvStrLen((const unsigned char *) test_srv_key), 0, 0)) != 0) {
	...
	rtl_printf("\n\r  . Starting tcp server /%d.%d.%d.%d/%d...", ip[0], ip[1], ip[2], ip[3], 8443);

	if((ret = net_bind(&server_fd, 0, 8443)) != 0) {
		rtl_printf(" failed\n  ! net_bind returned %d\n\n", ret);
		goto exit;
	}
	...
	while((ret = net_accept(server_fd, &client_fd, 0)) == 0) {
		...
		ssl_set_ca_chain(&ssl, server_x509.next, 0, 0);
		ssl_set_authmode(&ssl, 0);
		ssl_set_rng(&ssl, my_random, 0);
		...
		if((ret = ssl_read(&ssl, buf, sizeof(buf))) <= 0) {
			if(ret != -0x0052 && ret != -0x0054) {
				rtl_printf(" failed\n\r  ! ssl_read returned %d\n", ret);
				goto close_client;
			}
		}
		rtl_printf(" %d bytes read\n\r\n\r%s\n", ret, (char *) buf);
		...
		rtl_sprintf(buf, "HTTP/1.1 200 OK\r\nContent-Type: text/html\r\nContent-Length: %d\r\n\r\n%s", prvStrLen((const unsigned char *) response), response);
		if((ret = ssl_write(&ssl, buf, prvStrLen((const unsigned char *) buf))) <= 0) {
			if(ret != -0x0052 && ret != -0x0054) {
				rtl_printf(" failed\n\r  ! ssl_write returned %d\n", ret);
				goto close_client;
			}
		}
		rtl_printf(" %d bytes written\n\r\n\r%s\n", ret, (char *)buf);

close_client:
#line 177 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\example\\ssl_server\\example_ssl_server.c"
...
{
	if(xTaskGenericCreate( ( example_ssl_server_thread ), ( "example_ssl_server_thread" ), ( 1150 ), ( 0 ), ( ( ( UBaseType_t ) 0U ) + 1 ), ( 0 ), ( 0 ), ( 0 ) ) != ( ( ( BaseType_t ) 1 ) ))
