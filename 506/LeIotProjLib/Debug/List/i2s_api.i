#line 1 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2s_api.c"
...
#line 18 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2s_api.c"
#line 1 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal_ext\\i2s_api.h"
...
#line 31 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal_ext\\i2s_api.h"
...
enum {
	SR_8KHZ = ((uint32_t)0x00000000), 
	SR_16KHZ = ((uint32_t)0x00000001),
	SR_24KHZ = ((uint32_t)0x00000002),
	SR_32KHZ = ((uint32_t)0x00000003),
	SR_48KHZ = ((uint32_t)0x00000005),
	SR_96KHZ = ((uint32_t)0x00000006),
	SR_7p35KHZ = ((uint32_t)0x00000010),
	SR_14p7KHZ = ((uint32_t)0x00000011),
	SR_22p05KHZ = ((uint32_t)0x00000012),
	SR_29p4KHZ = ((uint32_t)0x00000013),
	SR_44p1KHZ = ((uint32_t)0x00000015),
	SR_88p2KHZ = ((uint32_t)0x00000016)
};

enum {
	CH_STEREO = ((uint32_t)0x00000000),
	CH_MONO = ((uint32_t)0x00000002)
};

enum {
	WL_16b = ((uint32_t)0x00000000),
	WL_24b = ((uint32_t)0x00000001)
};

enum {
    I2S_DIR_RX   = ((uint32_t)0x00000000),    
    I2S_DIR_TX   = ((uint32_t)0x00000001),    
    I2S_DIR_TXRX = ((uint32_t)0x00000002)     
};
...
#line 210 "D:\\vm-share\\506\\LeIotProjLib\\..\\rtk8710_sdk\\component\\common\\mbed\\hal_ext\\i2s_api.h"
...
#line 19 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2s_api.c"
...
#line 20 "D:\\vm-share\\506\\rtk8710_sdk\\component\\common\\mbed\\targets\\hal\\rtl8711b\\i2s_api.c"
...
static I2S_USER_CB I2SUserCB; 
static uint32_t next_tx_complete = 0;
extern uint32_t i2s_cur_tx_page;
extern uint32_t i2s_cur_rx_page;
...
static void i2s_isr(void *Data)
{
	...
	uint8_t  I2SPageNum = I2SInitStruct.I2S_PageNum;
	uint32_t i;
	uint32_t pbuf;
	uint32_t cur_tx_page = 0;
	uint32_t cur_rx_page = 0;

	I2S_ISRGet(((I2S_TypeDef *) 0x40062000), &I2STxIsr, &I2SRxIsr);
	I2S_INTClear(((I2S_TypeDef *) 0x40062000), I2STxIsr, I2SRxIsr);

	for (i=0 ; i<I2SPageNum; i++) { 
		cur_rx_page = I2S_GetRxPage(((I2S_TypeDef *) 0x40062000));
...
void i2s_init(i2s_t *obj, PinName sck, PinName ws, PinName sd_tx, PinName sd_rx, PinName mck)
{
	...
	do { if ((LEVEL_INFO < LEVEL_NUMs) && (MODULE_I2S < MODULE_NUMs) && (ConfigDebug[LEVEL_INFO] & (1<<(MODULE_I2S)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "%s: Use I2S%d \n"; } }while(0);

	
	I2S_StructInit(&I2SInitStruct);

	 
	VECTOR_IrqRegister((IRQ_FUN) i2s_isr, I2S0_PCM0_IRQ, 0, 3);
	VECTOR_IrqEn(I2S0_PCM0_IRQ, 3);

	 
	PLL1_Set((0x00000001 << 9) | (0x00000001 << 10), 1);
	
	 
	((*((volatile uint32_t*)(0x40000000 + 0x0210))) = ((uint32_t)(((((uint32_t)(*((volatile uint32_t*)(0x40000000 + 0x0210)))) & (~(1<<(2))))|((0xFFFFFFFF - 1 + 1) & (1<<(2)))))));

	 
	RCC_PeriphClockCmd(((1<<(24)) | 2 << 30), ((1<<(16)) | (2<<29)), 1);
	Pinmux_Config(sck, (9));
	Pinmux_Config(ws, (9));
	Pinmux_Config(sd_tx, (9));
	Pinmux_Config(sd_rx, (9));
	Pinmux_Config(mck, (9));
	...
	I2S_Init(((I2S_TypeDef *) 0x40062000), &I2SInitStruct);

	 
	I2S_Cmd(((I2S_TypeDef *) 0x40062000), 1);
	I2S_INTConfig(((I2S_TypeDef *) 0x40062000), (((uint32_t)0x00000001 << 0)|((uint32_t)0x00000001 << 1)| ((uint32_t)0x00000001 << 2)|((uint32_t)0x00000001 << 3)),
		(((uint32_t)0x00000001 << 0)|((uint32_t)0x00000001 << 1) | ((uint32_t)0x00000001 << 2)|((uint32_t)0x00000001 << 3)));
}
	...
	uint32_t page_num, uint32_t page_size)
{
	...
	if ((page_num < 2) || (page_num > 4) || (page_size < 8)) {
		do { if ((LEVEL_INFO < LEVEL_NUMs) && (MODULE_I2S < MODULE_NUMs) && (ConfigDebug[LEVEL_INFO] & (1<<(MODULE_I2S)))) { _Pragma( "location=\".debug_trace\"") static const char traceFormat[] = "%s: PageNum(%d) valid value is 2~4; PageSize(%d must > 8)\r\n"; } }while(0);

		return;
	}

	I2SInitStruct.I2S_PageNum = page_num;
	I2SInitStruct.I2S_PageSize = page_size/4;    
	I2S_SetPageSize(((I2S_TypeDef *) 0x40062000), (page_size/4));
	I2S_SetPageNum(((I2S_TypeDef *) 0x40062000), (page_num));
	I2S_SetDMABuf(((I2S_TypeDef *) 0x40062000), (uint8_t*)tx_buf, (uint8_t*)rx_buf);
...
void i2s_set_direction(i2s_t *obj, int trx_type)
{
	...
	I2S_SetDirection(((I2S_TypeDef *) 0x40062000), trx_type);

	if (trx_type == I2S_DIR_TX) {
		I2S_RxDmaCmd(((I2S_TypeDef *) 0x40062000), 0);
	} else if ((trx_type == I2S_DIR_TXRX) ||(trx_type == I2S_DIR_RX) ) {
		I2S_RxDmaCmd(((I2S_TypeDef *) 0x40062000), 1);
	}
}
...
void i2s_set_param(i2s_t *obj, int channel_num, int rate, int word_len)
{
	...
	I2S_SetChNum(((I2S_TypeDef *) 0x40062000), I2SInitStruct.I2S_ChNum);
	I2S_SetRate(((I2S_TypeDef *) 0x40062000), rate);
	I2S_SetWordLen(((I2S_TypeDef *) 0x40062000), I2SInitStruct.I2S_WordLen);
}
...
void i2s_deinit(i2s_t *obj)
{
	...
	VECTOR_IrqDis(IrqNum);
	VECTOR_IrqUnRegister(IrqNum);
	
	 
	I2S_INTConfig(((I2S_TypeDef *) 0x40062000), 0, 0);
	I2S_Cmd(((I2S_TypeDef *) 0x40062000), 0);
...
int* i2s_get_tx_page(i2s_t *obj)
{
	...
	cur_tx_page = I2S_GetTxPage(((I2S_TypeDef *) 0x40062000));
	if (!I2S_TxPageBusy(((I2S_TypeDef *) 0x40062000), cur_tx_page)) {
...
void i2s_send_page(i2s_t *obj, uint32_t *pbuf)
{
	uint32_t cur_tx_page;

	cur_tx_page = I2S_GetTxPage(((I2S_TypeDef *) 0x40062000));

	if (I2S_GetTxPageAddr(cur_tx_page) != (uint32_t)pbuf)
		do { if ((ConfigDebugErr & 0x40000000)) DiagPrintf("\r" "%s: tx buffer not match cur_tx_page \n", __func__);}while(0);

	I2S_TxPageDMA_EN(((I2S_TypeDef *) 0x40062000), cur_tx_page);
}
...
void i2s_recv_page(i2s_t *obj)
{
	uint32_t cur_rx_page;

	cur_rx_page = I2S_GetRxPage(((I2S_TypeDef *) 0x40062000));

	if ((((I2S_TypeDef *) 0x40062000)->IS_RX_PAGE_OWN[cur_rx_page] & (1<<(31))) == 0) {
		I2S_RxPageDMA_EN(((I2S_TypeDef *) 0x40062000),cur_rx_page);
	} else {
