...
#if defined( RTK8710_FLASH_2M)
#define OTA2_DEFAULT_ADDR   (0x080F4000)
#elif defined(RTK8710_FLASH_1M)
#define OTA2_DEFAULT_ADDR   (0x08080000)
#else
#error You should define RTK8710_FLASH_2M or RTK8710_FLASH_1M
#endif
